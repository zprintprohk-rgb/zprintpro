...
const META = {
  'zh-hk': {
    ...
    description:
      '智印港 提供 5 大付款通道：銀行電匯 (DBS HK)、微信、支付寶、PayPal (跨境卡支付)、支付寶閃速收款 (跨境匯款)。30 秒 AI 報價後可選任一通道付款，72 小時全球交付。',
...
const SECTIONS = {
  'zh-hk': {
    ...
    h1: '付款方式一覽',
    subtitle:
      '智印港 提供 5 種付款通道，覆蓋中國大陸 / 香港本地 / 跨境（歐美、日本、澳洲）三大客群。選擇最適合你的方式，付款後 72 小時內全球交付。',
    badge1: '30 秒 AI 報價',
    badge2: '全球 72 小時交付',
    badge3: '100% 合規收款',
    onlineLabel: '線上支付',
    ...
    faqTitle: '常見問題',
    faqs: [
      { q: '最低訂單金額是多少？', a: '無最低金額限製，HK$100 起即可下單，量大從優。' },
