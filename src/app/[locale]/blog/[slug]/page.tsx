...
<p>想為您的品牌加入環保元素？<a href="https://wa.me/8618126380255" target="_blank">聯繫智印雲</a>獲取綠色印刷方案。</p>`,
    ...
    'food-packaging-printing-guide': {
      ...
      description: '專為香港餐飲品牌打造的食品包裝印刷完整指南。了解食品級材質選擇、FDA/FSC認證要求。',
      date: '2026-07-01', category: '包裝知識',
      content: '<p>香港餐飲市場競爭激烈，食品包裝是品牌的第一印象。超過68%的消費者表示包裝設計影響購買決定。</p><h3>材質選擇</h3><ul class="list-disc pl-5 my-3 space-y-1"><li><strong>食品級紙板</strong>：300g-600g，FSC認證，蛋糕盒/月餅盒適用</li><li><strong>牛皮紙</strong>：120g-250g，環保可降解，適合烘焙包裝</li><li><strong>淋膜紙</strong>：200g-350g，防油防水，外賣飯盒適用</li></ul><p>了解更多：<a href="/zh-hk/category/packaging/">包裝盒訂製</a></p>',
    },
    'flyer-printing-guide': {
      title: '宣傳單張印刷指南：尺寸、紙質與設計要點',
      description: '香港宣傳單張印刷專業指南。A4/A5尺寸、157g-300g多種紙質，48小時交貨。AI即時報價。',
      date: '2026-07-01', category: '印刷知識',
      content: '<p>宣傳單張是香港最有效的推廣工具之一，實體傳單仍有3-5%回響率。</p><h3>尺寸選擇</h3><ul class="list-disc pl-5 my-3 space-y-1"><li><strong>A5 (148×210mm)</strong>：最常見</li><li><strong>A4 (210×297mm)</strong>：適合詳細產品目錄</li></ul><p>了解更多：<a href="/zh-hk/category/flyers/">傳單印刷</a></p>',
    },
    },
  },
  en: {
    ...
    'food-packaging-printing-guide': {
      ...
      description: 'A complete guide to food packaging printing for Hong Kong F&B brands.',
      date: '2026-07-01', category: 'Packaging Guide',
      content: '<p>Food packaging is crucial for Hong Kong F&B brands.</p><h3>Material Options</h3><ul class="list-disc pl-5 my-3 space-y-1"><li><strong>Food-grade paperboard</strong>: 300g-600g, FSC certified</li><li><strong>Kraft paper</strong>: 120g-250g, eco-friendly</li></ul><p>Learn more: <a href="/en/category/packaging/">Custom packaging</a></p>',
    },
    'flyer-printing-guide': {
      title: 'Flyer Printing Guide: Sizes, Paper & Design Tips for Hong Kong',
      description: 'Hong Kong flyer printing guide. A4/A5 sizes, 157g-300g paper, 48h delivery.',
      date: '2026-07-01', category: 'Printing Guide',
      content: '<p>Flyers remain effective promotion tools in Hong Kong.</p><h3>Size Options</h3><ul class="list-disc pl-5 my-3 space-y-1"><li><strong>A5 (148\u00d7210mm)</strong>: Most common</li><li><strong>A4 (210\u00d7297mm)</strong>: For detailed catalogs</li></ul><p>Learn more: <a href="/en/category/flyers/">Flyer printing</a></p>',
    },
  },
  ja: {
    ...
    'food-packaging-printing-guide': {
      ...
      description: '香港の飲食ブランド向け食品包装印刷完全ガイド。',
      date: '2026-07-01', category: '包装知識',
      content: '<p>香港の飲食市場は競争が激しく、食品包装はブランドの第一印象を決める重要な要素です。</p><h3>素材選び</h3><ul class="list-disc pl-5 my-3 space-y-1"><li><strong>食品級板紙</strong>：300g-600g、FSC認証</li><li><strong>クラフト紙</strong>：120g-250g、環境に優しい</li></ul><p>詳細：<a href="/ja/category/packaging/">包装カスタマイズ</a></p>',
    },
    'flyer-printing-guide': {
      title: 'チラシ印刷ガイド：サイズ、用紙、デザインのポイント',
      description: '香港チラシ印刷の専門ガイド。A4/A5サイズ、157g-300g用紙。',
      date: '2026-07-01', category: '印刷技術',
      content: '<p>チラシは香港で最も効果的な広告手段の一つです。</p><h3>サイズ選び</h3><ul class="list-disc pl-5 my-3 space-y-1"><li><strong>A5</strong>：148×210mm、最も一般的</li><li><strong>A4</strong>：210×297mm、詳細な情報に最適</li></ul><p>詳細：<a href="/ja/category/flyers/">チラシ印刷</a></p>',
    },
  },
};
