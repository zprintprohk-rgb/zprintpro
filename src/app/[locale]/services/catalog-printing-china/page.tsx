...
const T: Record<string, {
  ...
  'zh-hk': {
    ...
    keyword_clusters: [
      { kw: 'china catalog printing', intent: '跨境大單 (主詞)', volume: '~32 次搜尋/週' },
      { kw: 'china printing factory', intent: '尋源意圖明確', volume: '~18 次搜尋/週' },
      { kw: 'shenzhen printing factory', intent: '產地直擊', volume: '~12 次搜尋/週' },
      { kw: 'bulk catalog printing', intent: 'B2B 批量', volume: '~14 次搜尋/週' },
      { kw: 'wholesale catalog printing', intent: 'B2B 批發', volume: '~10 次搜尋/週' },
    ],
  ...
  'en': {
    ...
    keyword_clusters: [
      { kw: 'china catalog printing', intent: 'Cross-border bulk (primary)', volume: '~32 searches/week' },
      { kw: 'china printing factory', intent: 'Sourcing intent clear', volume: '~18 searches/week' },
      { kw: 'shenzhen printing factory', intent: 'Origin-targeted', volume: '~12 searches/week' },
      { kw: 'bulk catalog printing', intent: 'B2B bulk order', volume: '~14 searches/week' },
      { kw: 'wholesale catalog printing', intent: 'B2B wholesale', volume: '~10 searches/week' },
    ],
  ...
  'ja': {
    ...
    keyword_clusters: [
      { kw: '中国カタログ印刷', intent: '越境大口（主キーワード）', volume: '～32 検索/週' },
      { kw: '中国印刷工場', intent: 'ソーシング明確', volume: '～18 検索/週' },
      { kw: '深セン印刷工場', intent: '産地直撃', volume: '～12 検索/週' },
      { kw: '大量カタログ印刷', intent: 'B2Bバルク', volume: '～14 検索/週' },
      { kw: '卸売カタログ印刷', intent: 'B2Bホールセール', volume: '～10 検索/週' },
    ],
