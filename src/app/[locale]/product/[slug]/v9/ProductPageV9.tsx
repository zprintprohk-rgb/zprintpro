...
const T: Record<'zh-hk' | 'en' | 'ja', Record<string, any>> = {
  'zh-hk': {
    ...
    ctaFooterDesc: 'WhatsApp 客服 +86 198 8085 1334 或點擊「30 秒 AI 報價」· 2 小時內回覆 · 免費設計諮詢',
    relatedTitle: '相關產品',
    viewAll: '查看全部 →',
    mrailQuote: '30 秒報價',
  ...
  en: {
    ...
    ctaFooterDesc: 'WhatsApp +86 198 8085 1334 or click "30-sec AI Quote" · replies within 2 hours · free design consultation',
  ...
  ja: {
    ...
    ctaFooterDesc: 'WhatsApp +86 198 8085 1334 または「30秒無料見積もり」 · 2時間以内に返信 · 無料デザイン相談',
    relatedTitle: '関連製品',
    viewAll: 'すべて見る →',
    mrailQuote: '30秒見積もり',
    metaRows: (unit: string): [string, string][] => [
