...
const translations = {
  'zh-hk': {
    ...
    titleShort: '經營者資訊披露',
    description:
      '智印港 經營者資訊披露：包括公司資料、商品銷售條款及聯絡方式。跨境電商，全球配送。',
    h1: '經營者資訊披露',
    lastUpdated: '最後更新日期',
    sectionCrossBorder: '關於經營者',
    crossBorderBody:
      '智印港 為於中華人民共和國深圳市註冊成立之國際印刷服務商。本網站以跨境電商形式銷售印刷產品至全球多個市場，包括香港、中國內地、日本、美國、英國、澳大利亞等地。我們於香港並無實體門市或營業所，所有交易均透過本網站及國際速遞完成。本頁面根據適用之消費者保護法規要求，向客戶披露經營者資訊。',
    sectionSeller: '經營者資訊',
