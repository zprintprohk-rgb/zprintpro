...
const translations = {
  'zh-hk': {
    ...
    about: '公司簡介',
    aboutText: `ZprintPro 智印港成立於2018年，總部位於香港觀塘，是香港領先的專業印刷服務供應商。我們為超過3,000家香港企業提供高品質印刷解決方案，產品涵蓋名片、傳單、貼紙、包裝盒、紙袋、海報、書籍、利是封等79個品類。我們的使命是讓每一位客戶都能以合理的價格，獲得超出預期的印刷品質。`,
    stats: '核心數據',
    statItems: [
