...
const translations = {
  'zh-hk': {
    ...
    contact: '媒體聯絡',
    contactName: '唐先生（市場部）',
    contactRole: '智印港 市場總監',
    contactEmail: 'zprintpro@outlook.com',
    contactPhone: '+8619880851334',
    contactNote: '媒體查詢優先處理，2 小時內回覆',
    about: '公司簡介',
    aboutText: `智印港成立於2012年，總部位於中華人民共和國廣東省深圳市龍崗區平湖街道嘉城路1號，是面向香港及全球市場的國際印刷服務品牌。我們為全球超過3,000家企業提供高品質印刷解決方案，產品涵蓋贴纸、傳單、貼紙、包裝盒、紙袋、海報、書籍、利是封等79個品類。我們的使命是讓每一位客戶都能以合理的價格，獲得超出預期的印刷品質。`,
    stats: '核心數據',
    statItems: [
  ...
  en: {
    ...
    contactEmail: 'zprintpro@outlook.com',
    contactPhone: '+8619880851334',
    contactNote: 'Media inquiries receive priority response within 2 hours',
    about: 'Company Overview',
    aboutText: `Founded in 2012 and headquartered in Shenzhen, Guangdong, China, ZprintPro is an international printing service brand serving Hong Kong and global markets. We serve over 3,000 businesses worldwide with high-quality printing solutions across 79 product categories, including stickers, flyers, stickers, packaging boxes, paper bags, posters, books, and red packets. Our mission is to help every client achieve exceptional print quality at a fair price.`,
    stats: 'Key Metrics',
    statItems: [
    ...
    factItems: [
      ...
      { label: 'Core Products', value: 'Stickers, flyers, stickers, boxes, bags, posters, books' },
  ...
  ja: {
    ...
    contactEmail: 'zprintpro@outlook.com',
    contactPhone: '+8619880851334',
    contactNote: 'メディアからのお問い合わせは2時間以内に優先対応',
    about: '会社概要',
    aboutText: `2012年に設立され、中華人民共和国広東省深圳市龍崗区平湖街道嘉城路1号に本社を構えるZprintProは、香港を含む世界市場向けの国際印刷サービスブランドです。世界中の3,000社以上の企業に高品質な印刷ソリューションを提供しており、グリーティングカード、チラシ、ステッカー、包装箱、紙袋、ポスター、書籍、紅包など79の製品カテゴリーを展開しています。私たちのミッションは、すべてのクライアントが適正な価格で期待を超える印刷品質を得られるようにすることです。`,
    stats: '主要指標',
    statItems: [
    ...
    factItems: [
      ...
      { label: '主要製品', value: 'グリーティングカード、チラシ、ステッカー、包装箱、紙袋、ポスター、書籍' },
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-xl border border-gray-100 p-6">
                ...
                <a
                  href={`/${locale}/product/premium-stickers/`}
                  className="inline-flex items-center px-4 py-2 bg-[#2873F5] text-white rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors"
                >
