...
const translations = {
  'zh-hk': {
    ...
    intro: '歡迎使用智印港 ZprintPro 服務。當您瀏覽本網站、下單購買或使用本網站任何服務時，即代表您同意以下條款。請仔細閱讀。',
    sections: [
      {
        title: '1. 服務範圍',
        body: '智印港 ZprintPro 提供跨境印刷服務，包括貼紙、紙袋、包裝盒、海報、宣傳單張等度身訂製印刷產品。具體產品規格、價格及交貨時間以各商品頁面標示為準。',
      },
      {
        title: '2. 訂單與付款',
      ...
      {
        title: '6. 知識產權',
        body: '您保證所提供之印刷稿件擁有合法之知識產權或已獲授權使用。智印港 ZprintPro 對因侵犯第三方知識產權而引起之糾紛概不負責。',
      },
      {
        title: '7. 責任限制',
        body: '智印港 ZprintPro 對因不可抗力（包括但不限於天災、戰爭、疫情、海關扣押、運輸延誤等）造成之延誤或損失，僅負責重印或退款，不承擔其他間接損失。',
      },
      {
        title: '8. 適用法律及爭議解決',
      ...
      {
        title: '9. 條款修改',
        body: '智印港 ZprintPro 保留隨時修改本條款之權利。修改後將於本頁公布，並標示最後更新日期。',
      },
      {
        title: '10. 聯絡我們',
