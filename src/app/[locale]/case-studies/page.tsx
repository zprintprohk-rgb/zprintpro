...
const translations = {
  'zh-hk': {
    metaTitle: '客戶案例 | 智印雲 ZprintPro 印刷成功案例',
    metaDesc: '瀏覽智印雲為香港及全球企業提供的印刷解決方案案例，涵蓋餐飲、零售、金融、教育、美容等行業。',
    h1: '客戶成功案例',
    ...
    caseStudies: [
      {
        ...
        quote: '智印雲的防水餐牌解決了我們長期以來的困擾，現在即使打翻湯水也只需輕輕一擦。',
        author: '陳經理',
        role: '營運總監',
      },
      {
        ...
        quote: '包裝的質感直接決定了客戶對品牌的第一印象，智印雲幫我們做到了。',
        author: '林小姐',
        role: '品牌創辦人',
      },
      {
      ...
      },
      {
        ...
        quote: '開學前最頭痛的就是教材印刷，智印雲總能準時甚至提前交付。',
        author: '張主任',
        role: '教務主任',
      },
      {
      ...
      },
      {
        ...
        quote: '急單交給智印雲從來沒出過問題，品質和速度都有保障。',
        author: '劉小姐',
        role: '項目經理',
      },
      {
    ...
    caseStudies: [
      {
        ...
        quote: '智印雲の防水メニューは長年の悩みを解決しました。こぼしたスープもサッと拭けます。',
        author: '陳マネージャー',
        role: '運営ディレクター',
      },
      {
        ...
        quote: 'パッケージの質感がブランドの第一印象を決めます。智印雲が実現してくれました。',
        author: '林さん',
        role: 'ブランド創業者',
      },
      {
      ...
      },
      {
        ...
        quote: '学期開始前の最大の悩みは印刷です。智印雲はいつも期日内、時には前倒しで納品してくれます。',
        author: '張主任',
        role: '教務主任',
      },
      {
      ...
      },
      {
        ...
        quote: '急ぎの注文を智印雲に任せて一度も失敗したことがありません。品質も速度も保証されています。',
        author: '劉さん',
        role: 'プロジェクトマネージャー',
      },
      {
