...
const translations = {
  'zh-hk': {
    metaTitle: '客戶案例 | 智印港 ZprintPro 印刷成功案例',
    metaDesc: '瀏覽智印港為香港及全球企業提供的印刷解決方案案例，涵蓋餐飲、零售、金融、教育、美容等行業。',
    h1: '客戶成功案例',
    ...
    caseStudies: [
      {
        industry: '連鎖餐飲',
        client: '港式茶餐廳集團（8間分店）',
        need: '需要統一品牌的防水餐牌與傳單印刷，應對香港潮濕氣候與頻繁翻台',
        solution: '採用300g銅版紙覆啞膜餐牌，配合PVC防水貼紙標註限時優惠；A5傳單印刷雙面印刷派發',
        products: ['防水餐牌', 'A5傳單印刷', 'PVC防水貼紙'],
        result: '餐牌壽命延長3倍，翻台率提升15%，單月新增會員2000+',
        quote: '智印港的防水餐牌解決了我們長期以來的困擾，現在即使打翻湯水也只需輕輕一擦。',
        author: '陳經理',
        role: '營運總監',
      },
      {
        industry: '美容護膚',
        client: '本地有機護膚品牌',
        need: '新品牌上市，需要高端包裝盒與品牌卡片建立專業形象',
        solution: '350g白卡紙磁吸禮盒配合燙金Logo；300g啞粉紙卡片局部UV工藝',
        products: ['磁吸禮盒', '啞膠卡片', '透明貼紙'],
        result: '開業首月售出500套禮盒，Instagram打卡率提升40%',
        quote: '包裝的質感直接決定了客戶對品牌的第一印象，智印港幫我們做到了。',
        author: '林小姐',
        role: '品牌創辦人',
      },
      {
        industry: '金融法律',
        client: '中型律師事務所',
        need: '400g厚身卡片與企業畫冊，展現專業權威與品牌一致性',
        solution: '400g超厚銅版紙卡片配合啞膠覆膜；膠裝畫冊157g銅版紙四色印刷',
        products: ['厚身卡片(400g)', '膠裝畫冊', 'A4傳單印刷'],
        result: '客戶卡片留存率提升60%，畫冊在業界會議中獲得高度評價',
        quote: '第一次拿到400g卡片時，客戶都說這是他們見過最有份量的律師卡片。',
        author: '黃律師',
        role: '合夥人',
      },
      {
        industry: '教育培訓',
        client: '補習社連鎖（5間分校）',
        need: '開學季大量教材、練習簿與傳單印刷，要求快速交付與色彩一致',
        solution: '數碼印刷練習簿1000本3天交付；A5傳單印刷雙面彩色派發',
        products: ['練習簿', 'A5傳單印刷', '證書'],
        result: '5間分校教材統一到貨，招生率同比提升25%',
        quote: '開學前最頭痛的就是教材印刷，智印港總能準時甚至提前交付。',
        author: '張主任',
        role: '教務主任',
      },
      {
      ...
      },
      {
        industry: '活動策劃',
        client: '大型會展公司',
        need: '展會Backdrop、易拉寶與傳單印刷，要求即日取貨',
        solution: 'Backdrop背景板2.4×3m UV噴繪；易拉寶85×200cm當日交付',
        products: ['Backdrop背景板', '易拉寶', 'A4傳單印刷'],
        result: '展會佈置準時完成，客戶現場簽約率提升30%',
        quote: '急單交給智印港從來沒出過問題，品質和速度都有保障。',
        author: '劉小姐',
        role: '項目經理',
      },
      {
        industry: '房地產',
        client: '新盤代理公司',
        need: '樓書、傳單印刷與大型海報，高質感呈現物業賣點',
        solution: '200g厚紙傳單印刷；A1海報PP合成紙防水；膠裝樓書',
        products: ['厚紙傳單印刷', 'A1海報', '膠裝畫冊'],
  ...
  en: {
    ...
    caseStudies: [
      ...
      },
      {
        ...
        need: 'Premium packaging and greeting cards for new brand launch',
    ...
    caseStudies: [
      {
        ...
        quote: '智印港の防水メニューは長年の悩みを解決しました。こぼしたスープもサッと拭けます。',
        author: '陳マネージャー',
        role: '運営ディレクター',
      },
      {
        ...
        need: '新ブランド立ち上げに向けた高級パッケージとグリーティングカード',
        solution: '350g白カード磁石式ギフトボックスに箔押しロゴ。300gマット紙カードに局部UV',
        products: ['磁石式ギフトボックス', 'マットカード', '透明ステッカー'],
        result: '初月500セット完売、Instagramチェックイン率40%向上',
        quote: 'パッケージの質感がブランドの第一印象を決めます。智印港が実現してくれました。',
        author: '林さん',
        role: 'ブランド創業者',
      },
      {
        industry: '金融法律',
        client: '中規模法律事務所',
        need: '400g厚紙カードと企業カタログで専門的な権威とブランド一貫性を演出',
        solution: '400g超厚コート紙カードにマットラミネート。157gコート紙4色印刷の無線綴じカタログ',
        products: ['厚紙カード(400g)', '無線綴じカタログ', 'A4チラシ'],
        result: 'カード保持率60%向上、カタログは業界イベントで高評価',
        quote: '400gカードを受け取ったクライアントは、今までで最も重厚な弁護士カードだと言いました。',
        author: '黄弁護士',
        role: 'パートナー',
      },
      {
        ...
        quote: '学期開始前の最大の悩みは印刷です。智印港はいつも期日内、時には前倒しで納品してくれます。',
        author: '張主任',
        role: '教務主任',
      },
      {
      ...
      },
      {
        ...
        quote: '急ぎの注文を智印港に任せて一度も失敗したことがありません。品質も速度も保証されています。',
        author: '劉さん',
        role: 'プロジェクトマネージャー',
      },
      {
