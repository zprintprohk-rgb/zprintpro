...
export const SEO_KEYWORDS: SeoKeyword[] = [
  ...
  },
  {
    ...
    description: {
      // 2026-09-19 全站起訂量修正: 500 起 → 10 起 (紙品線, 與 price-table 小批量檔同源)
      'zh-hk': '香港傳單印刷印刷｜智印港提供 A4/A5/DL 傳單印刷、Leaflet、傳單印刷，銅版紙/啞粉紙可選，10張起印，免費送貨。全港最低價保證，立即網上報價！',
      en: 'Flyer printing worldwide. A4/A5/DL flyers, leaflets. Coated/matte paper. 10 pcs MOQ, free delivery. Best price guaranteed!',
      ja: 'チラシ印刷。A4/A5/DL チラシ、Leaflet。コート紙/マット紙。10枚から。',
    },
    h1: {
    ...
    body: {
      'zh-hk': [
        ...
        '起訂量：10 張起印，量大優惠，同批 4 款起可拼版降低成本',
      ...
      en: [
        ...
        'MOQ: 10 sheets, volume discount, 4-design gang-run available',
