// BC-BAN-DEPRECATED (2026-09-09 K3 拍板②): 本模块断注册保留 — deprecated 原因 = AGENTS.md §0.0 最高规则「禁做名片印刷」(K3 2026-09-08 01:15 终裁)。
// 引擎注册已移除（engine.ts REGISTRY 不再引用）；代码与配套测试保留备查，禁止重新注册或在新代码中 import。
