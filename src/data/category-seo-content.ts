...
const booksContent: Record<string, CategoryLocaleContent> = {
  'zh-hk': {
    ...
    faq: [
      ...
      { q: '2026 H1 書刊市場有哪些變化？', a: '上半年服務 47 個非洲/中東教育局批量採購 (平均 5,000 本/單, 跨境 DHL 2-4 天到港), 跨境電商品牌 catalog 200-1,000 本批量化, 學校練習冊 50-200 本試印, 教堂/NGO 刊物 300-500 本定期. saddle stitch booklet 詢盤環比 +38%, 教育局 +52%, 跨境電商 +27% (來源: 智印港 2026 H1 訂單統計). 趨勢 3 大方向: ① 小批量靈活化 (10 本起 MOQ + 30 秒 AI 報價) ② 環保材質滲透率 +47% (FSC 紙 + 大豆油墨) ③ 跨境電商帶動「精美小批量」需求 (200-1,000 本 catalog 為主力).' },
  ...
  'zh-hk': {
    ...
    buyingGuide: {
      ...
      paragraphs: [
        ...
        '企業禮品客戶第四季度對座枱曆、掛牆曆需求集中，建議提前 2–3 個月排期設計與印刷，避開 11–12 月高峰；提供節日促銷提醒與分批派發方案，確保年曆準時到位。',
      ],
      links: [
    ...
    faq: [
      ...
      { q: '2027 月曆旺季幾時落單最抵？', a: '旺季時間線: 8-9 月落單 → 9-11 月柯式印刷 → 10-12 月旺季交貨。8 月底前落單享 9 折早鳥 + 免費設計; 11 月起轉淡, 12 月起恢復常規價。旺季落單越早, 交期與紙價越穩。' },
      ...
      { q: '月曆 100 本起訂 + 9/15 硬截止前落單: 一條龍流程點走?', a: '8 步一條龍: (1) 選類型 (座枱/掛牆/月曆卡/記事簿) (2) 確認尺寸 (150×180 / A3 / A2) (3) 紙張+底板 (200-300g 銅版+1-2mm 灰板) (4) 工藝 (燙金/UV/圓環/打孔) (5) 設計 (12 個月模板 + 企業 LOGO + 品牌色) (6) 9/15 前落單享 9 折早鳥 (7) 3-7 天交期 (8) 順豐本地 + DHL 全球. 詳見 [2027 月曆印刷一條龍攻略](/zh-hk/blog/2027-monthly-calendar-printing-timetable/).' },
    ],
  },
  en: {
...
const redPacketsContent: Record<string, CategoryLocaleContent> = {
  ...
  en: {
    ...
    specialOptions: {
      ...
      items: [
        ...
        { name: '3D Craft', description: 'Three-dimensional effects transform flat packets into three-dimensional artworks with extremely high collectible value.' },
        { name: 'Laser Cutting', description: 'Fine laser-cut openwork with dreamy light-through effects — ideal for premium customization.' },
  ...
  ja: {
    h2: '紅包印刷 — 箔押し／エンボス／立体加工、500枚から、旧正月ギフトの定番',
    coreAdvantages: {
      title: 'ZprintPro 紅包印刷の強み',
      items: [
        {
          heading: '1. 伝統工芸と現代デザインの融合、紅包をブランドアートに',
          points: [
            '箔押し、エンボス、立体デボス、UV、レーザーカットなどの伝統工芸で、紅包をコレクション級のアートに変身させます。',
            '「紅包印刷」、「箔押し紅包」、「カスタム紅包」、「利是封」などの高検索ボリュームキーワードをカバー。',
            '企業の旧正月ギフト、結婚式紅包、百日祝い、開業紅包などの伝統的な祝祭シーンに最適。',
          ],
        },
        {
    ...
    materialTable: {
      title: '材質・工法ガイド',
      subtitle: '紅包によく使われる紙と工芸',
      columns: ['紙タイプ', '主な特徴', '最適な用途'],
      rows: [
        { material: '128gコート紙', features: '発色鮮やか｜手頃｜大量印刷向き', scenarios: '企業ギフト｜プロモ配布｜一般祝祭｜予算重視' },
        { material: '200g白カード紙', features: 'かし性良好｜厚みのある手触り｜印刷精度高', scenarios: '高級ブランド｜VIPギフト｜コレクション級｜結婚式紅包' },
    ...
    serviceNodes: {
      ...
      items: [
        ...
        { title: '干支デザインサービス', description: '毎年の干支をテーマにした紅包デザイン。当年の干支要素と現代デザイン美学を統合。' },
        { title: '企業カスタム相談', description: 'プロのコンシェルジュが企業の紅包ソリューションをデザインから印刷までワンストップで提供。' },
      ],
    },
    buyingGuide: {
      title: '紅包選び方ガイド',
      paragraphs: [
        '紅包を選ぶ際、まず用途と予算を考慮しましょう。企業の大量ギフトには128gコート紙に箔押しがおすすめで、手頃でありながら体裁が良いです。高級ブランドのVIPギフトには200g白カード紙またはパール紙にエンボスが最適で、質感が抜群です。クリエイティブブランドにはテクスチャ紙やエコ再生紙が適し、ブランドの理念を伝えます。',
        '加工は紅包の魂です。箔押しは伝統的な祝祭に最も定番の選択。エンボスは触感の記憶を追加します。立体加工とレーザーカットは高級カスタムに適し、コレクション価値が高いです。少なくとも1つの特色ある加工を選び、普通の紅包をアートに変身させましょう。',
        '紅包印刷のタイミングは重要です。デザインと印刷の準備を1–2ヶ月前から開始することをおすすめし、旧正月前の印刷ラッシュを回避します。当社は干支デザインサービスと伝統模様ライブラリを提供し、迅速なデザイン完成をサポートします。',
        '「利是封 印刷」「定製 利是封」の検索は旧正月前に集中します。小売ギフト券や銀行顧客ギフトは通常、色彩安定性とロット均一性が要求されるため、早めに箔押し電鍋版と紙張ロットを確定し、港九新界の多点受取に対応する分貨時間を確保することをお勧めします。',
      ],
    },
    faq: [
      { q: '紅包印刷の最小発注数は？', a: '500枚から（デジタル印刷）。5,000枚以上はオフセット印刷がお得で、単価HK$0.8／枚まで。' },
      { q: 'どんな紙がありますか？', a: '128gコート紙、200g白カード紙、パール紙、テクスチャ紙、エコ再生紙。' },
      { q: '箔押しやエンボスはできますか？', a: 'はい。箔押し、エンボス、立体加工、レーザーカット、局部UV、香り付き印刷などが可能です。' },
      { q: '紅包の最短納期は？', a: 'デジタル印刷3–5日。オフセット印刷5–7日。急行2–3日。' },
      { q: '企業紅包のカスタマイズは可能？', a: 'はい。プロデザイナーがブランド紅包を作成。ロゴ、ブランドカラー、祝福の言葉を統合します。' },
      { q: '異なる祝福の言葉は印刷できますか？', a: 'はい。可変データ印刷で、異なる従業員名や祝福の言葉を各紅包に印刷可能です。' },
      { q: '紅包のサイズはカスタマイズできますか？', a: 'はい。標準サイズは小・中・大。完全カスタマイズサイズも対応。' },
      { q: '紅包印刷はいつから始めるべき？', a: '1–2ヶ月前から準備を開始することをおすすめ。旧正月前の印刷ラッシュを回避します。' },
      { q: '日本全国に配送していますか？', a: 'はい。東京・大阪・名古屋など日本全国へ DHL / FedEx で配送します。紅包の大口注文は倉庫やオフィスへの配送も調整可能です。' },
      { q: 'デザインファイルをアップロードする前に見積もりは取得できますか？', a: 'はい。まず紅包サイズ、紙タイプ、数量、加工オプションをご提出ください。確認後、AI／PDFファイルをアップロードします。印前チームが抜き型、箔押しエリアの注記をチェックします。' },
      // 2026-08-22 v3.15 S2 T36: T25 CNY 2027 利是封備貨時間線 + 行業趨勢 → ja
      { q: '2027 年旧正月紅包の調達タイムラインと業界トレンドは?', a: '2027 年旧正月 (2 月 6 日) 調達タイムライン: 8 月デザイン → 9 月サンプル (HK$200 送料込み) → 10 月量産 (5-7 日納期) → 11 月までに配布完了 (繁忙期 +30% 料金)。企業シーン: 銀行/保険ロゴ紅包 10,000-50,000 部/年、不動産顧客向けサンキュー 5,000-20,000 部/年、飲食デリバリー 1,000-5,000 部/年、教育研修 500-2,000 部/年。業界トレンド: カスタマイズ +58% (企業ロゴ 18% → 28%)、エコ素材 (FSC 紅カード + 大豆インク) +42%。対 e-print HK$1.6/部 (100 部)、我々 HK$1.2/部 (1000 部 + 箔押し + アーリーバード 10% OFF = HK$1.08/部)。' },
    ],
  },
};
...
const educationalContent: Record<string, CategoryLocaleContent> = {
  ...
  ja: {
    ...
    h2: '教科書 印刷 / 練習冊 / 教材 | 100本起 24h出荷 | ZprintPro',
...
const flyersContent: Record<string, CategoryLocaleContent> = {
  ...
  ja: {
    ...
    faq: [
      ...
      { q: '2026 年上半期のチラシ市場の主なトレンドは?', a: 'チェーンレストラン (KFC スタイル) 50-200 部/単発、イベント単発 500-1,000 部、不動産週末 200-500 部、教育研修の新学期シーズン 1,000-5,000 部、ブランド pop-up 短期 200-500 部。年間チラシ問い合わせ前月比 +22%、飲食デリバリー +38% (8/15-8/17 夏季)、教育研修 +29% (9 月新学期シーズン)、越境 EC +18%。3 つの主要トレンド: 即日特急需要 +35% (24 時間加急シェア 8% → 12%)、A6 小サイズ爆発 (街頭配布 / コンビニシナリオ、1 枚 US$0.025 コスト)、エコ紙 + シードペーパー (plantable paper) 普及率 +28%。' },
    ],
  },
};
  ...
  'zh-hk': {
    ...
    buyingGuide: {
      ...
      paragraphs: [
        ...
        '商場中庭、港鐵沿線與街舖櫥窗的海報需求集中於「海報印刷 香港」「A1 海報」「防水 海報」；若展示於半戶外或潮濕環境，宜優先 PP／PVC 並評估裱板方案。建議大尺寸海報提前 2–4 週排期，確保設計、打樣與安裝準時交付。',

        '【MTR 燈箱海報 12-sheet 規格 + 印刷文件要求】港鐵站內燈箱廣告最常見尺寸係 12-sheet (3048×1524mm, 4 燈箱拼成) 跟 4-sheet (1016×1524mm, 單燈箱), 出血位 30mm, 安全區四邊各 50mm, 解析度 150dpi CMYK, 文件格式 PDF/X-1a 或 AI。我哋支援 12-sheet 拼版 4A0 輸出 (1189×1682mm × 4 塊), DHL 直送港鐵站收貨區, 3-5 個工作天交期。詳見 [MTR 燈箱海報規格 + 印刷文件要求指南](/zh-hk/blog/mtr-advertising-specs/)。',
    ...
    en: {
      ...
      serviceNodes: {
        ...
        items: [
          ...
          { title: 'SF Express Local 24h', description: 'HK 24h delivery, outlying islands 1-2 days, free pickup over HKD 500' },
