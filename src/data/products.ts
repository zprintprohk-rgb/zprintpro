...
export const products: Product[] = [
...
},
  {
    ...
    description: '禮品紙袋印刷訂製，100個起印，HK$3.5起/個。棉繩緞帶手挽，燙金UV壓凹工藝，支援多尺寸客製LOGO。適合品牌活動週年慶贈品，即日交貨，全港免費送貨。 适配行業: 婚慶、珠寶鐘錶、茶飲食品、服裝、禮品、品牌活動、酒店迎賓. **適配行業**: 婚慶/珠寶鐘錶/茶飲食品/服裝/禮品店/品牌活動/酒店迎賓.', descriptionEn: 'Exquisite design with foil stamping, UV and other processes. Essential for gifting, elevates gift quality., ISO 9001:2015 certified quality management system. Custom printed gift bags · 100 MOQ · Foil logo option · Wedding favor, retail, event bags. Free design mockup. 适配行業: Wedding, Jewelry & Watches, Tea & Beverage, Apparel, Gifts, Brand events, Hotel hospitality. **Best for**: weddings / jewelry & watches / tea & F&B / apparel / gift shops / brand events / hotel welcome.', descriptionJa: '精巧なデザイン、箔押し・UVなどの加工付き。ギフトに必須、ギフトの質を向上。。オリジナルギフト紙袋・100枚から・箔押し選択可。ウェディング・小売・イベント用。校正無料。 适配行業: ウェディング、宝飾・腕時計、茶・飲料、アパレル、ギフト、ブランドイベント、ホテル. **適合業種**: 婚礼 / 宝飾時計 / お茶飲食 / アパレル / ギフトショップ / ブランドイベント / ホテル歓迎.', description_zh: '精美設計，配合燙金、UV等工藝。送禮必備，提升禮品檔次。 适配行業: 婚慶、珠寶鐘錶、茶飲食品、服裝、禮品、品牌活動、酒店迎賓. **適配行業**: 婚慶/珠寶鐘錶/茶飲食品/服裝/禮品店/品牌活動/酒店迎賓.',
    features: [
      '禮贈場景導向，工藝層次豐富',
      '可搭燙金、局部 UV、緞帶手挽',
      '袋型可加深底寬容納禮盒',
