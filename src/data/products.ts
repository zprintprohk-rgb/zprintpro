...
export const products: Product[] = [
  ...
  seoImages: {
    ...
    seoDescription: {"zh-hk": "食品包裝盒 | 包裝盒 / 禮品盒 / 化妝品盒 - 採用premium 350g SBS car配合matte or gloss 工藝。食品包裝盒印刷訂製，100個起印，HK$2.5起/個。FDA級食品接觸安全材質，牛皮紙白卡紙可選，支援燙適用於packaging。DHL全球2-4日速遞。免費設計,100個起印。", "en": "Apple packaging - premium 350g SBS cardboard wit with matte or gloss lamin. Food-grade material, safe and eco-friendly., ISO 9001:2015 c DHL global 2-4 day s...", "ja": "Apple パッケージ - premium 350g SBS carとmatte or gloss 仕上げ。食品包裝盒印刷訂製，100個起印，HK$2.5起/個。FDA級食 DHL 2-4日配送。無料デザイン、100個から。"},
