...
export const products: Product[] = [
  ...
  seoImages: {
    ...
    alt: {
      'zh-hk': '賀卡: 300g premium greeting cards with 4-color printing. Optional matte/gloss lamination, foil stamping, spot UV. Perfect for Christmas cards, New Year cards, wedding thank-you cards,... 智印港 ZprintPro 樣品。',
  ...
  seoImages: {
    ...
    alt: {
      'zh-hk': '賀卡: 400g ultra-thick greeting cards with substantial feel. Perfect for Christmas, New Year, wedding, milestone events. Optional foil stamping, UV, embossing. 智印港 ZprintPro 樣品。',
  ...
  seoImages: {
    ...
    alt: {
      'zh-hk': '賀卡: Foil-stamped greeting cards (gold/silver/rose gold). Metallic luster elevates premium feel for Christmas, wedding, baby 100-day celebration, thank-you cards. 智印港 ZprintPro 樣品。',
  ...
  seoImages: {
    ...
    alt: {
      'zh-hk': '賀卡: Spot UV greeting cards with logo/pattern highlight + matte substrate for high contrast. Strong visual impact for Christmas, New Year, thank-you cards. 智印港 ZprintPro 樣品。',
  ...
  seoImages: {
    ...
    alt: {
      'zh-hk': '賀卡: Matte lamination greeting cards with smooth anti-fingerprint premium feel. Ideal for minimalist Christmas, New Year, thank-you cards. 智印港 ZprintPro 樣品。',
  ...
  seoImages: {
    ...
    alt: {
      'zh-hk': '賀卡: Rounded corner greeting cards (R3mm die-cut), soft tactile feel with no corner lift. Perfect for cute Christmas, birthday, thank-you cards. 智印港 ZprintPro 樣品。',
