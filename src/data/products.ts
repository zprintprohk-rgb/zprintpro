...
export const products: Product[] = [
  ...
  // 書籍印刷 (5 SKU)
  {
    ...
    description: '香港畫冊/攝影集/產品型錄印刷服務，色彩還原度達 95%+。適合藝術展覽圖錄、品牌作品集、攝影集、企業年報、珍藏紀念冊。50 本起印，48 小時香港本地速遞。適用行業：藝術畫廊、品牌企業、婚慶攝影、教育院校、餐飲食品、美妝護膚、文創IP、政企機構。', descriptionEn: 'Catalog, photo book & exhibition lookbook printing with 95%+ color accuracy. Ideal for art exhibition lookbooks, brand portfolios, photography books, annual reports, keepsake albums. 100 MOQ, free design mockup, 30-second AI quote. Ideal for art galleries, brand portfolios, wedding photography, education, F&B, cosmetics, IP merchandise, and government/corporate publications.', descriptionJa: 'カタログ・寫真集・作品集印刷サービス、色再現性95%+。美術展作品集、ブランドポートフォリオ、寫真集、企業年報、記念アルバムに最適。100冊〜、無料デザインモックアップ、30秒 AI 見積もり。美術ギャラリー、ブランド、結婚式写真、教育機関、飲食、コスメ、同人、官公庁・企業出版物に最適。', description_zh: '香港畫冊/攝影集/產品型錄印刷服務，色彩還原度達 95%+。適合藝術展覽圖錄、品牌作品集、攝影集、企業年報、珍藏紀念冊。50 本起印，48 小時香港本地速遞。適用行業：藝術畫廊、品牌企業、婚慶攝影、教育院校、餐飲食品、美妝護膚、文創IP、政企機構。',
    features: [
