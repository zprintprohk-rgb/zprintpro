...
export const skuSeoData: Record<string, SkuSeoEntry> = {
  ...
  "a4-flyers": {
    ...
    "seo": {
      ...
      "en": {
        "title": "A4 Flyers for Holiday Cards | Free US Ship | ZprintPro",
  ...
  "hardcover-menus": {
    ...
    "seo": {
      ...
      "ja": {
        "title": "ハードカバー menu 印刷 | 上製本 箔押し 10冊〜 | ZprintPro",
  ...
  "spiral-notebooks": {
    ...
    "seo": {
      "zh-hk": {
        "title": "線圈筆記本 | A4/A5 膠裝/騎馬釘 | 10本起 HK$8起 | 智印港",
      ...
      "en": {
        "title": "Spiral Notebooks | Perfect Bound | $2.76 | ZprintPro",
      ...
      "ja": {
        "title": "スパイラルノート | 中綴じ/無線綴じ 10冊〜 | ZprintPro",
  ...
  "exercise-books": {
    ...
    "seo": {
      "zh-hk": {
        "title": "作業簿印刷 | 四色印刷 膠裝 | 10本起 HK$4起 | 智印港",
