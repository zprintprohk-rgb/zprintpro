...
export const skuSeoData: Record<string, SkuSeoEntry> = {
  ...
  "pvc-menus": {
    ...
    "seo": {
      "zh-hk": {
        "title": "PVC 餐牌印刷 · 防水防油覆膜 50本起 | 餐廳/咖啡店/酒吧菜單 | 智印港",
      ...
      "ja": {
        "title": "PVC menu | 防水 ラミネート | 100枚〜 ¥386〜 | ZprintPro",
  ...
  "drink-menus": {
    ...
    "seo": {
      "zh-hk": {
        "title": "餐廳酒水牌 | 防水 覆膜 圓角 | 100本起 HK$12起 | 智印港",
