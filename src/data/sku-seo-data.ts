...
export const skuSeoData: Record<string, SkuSeoEntry> = {
  ...
  "same-day-flyers": {
    ...
    "seo": {
      "zh-hk": {
        "title": "即日宣傳單張印刷 | HK$0.55起・2小時打稿・即日交貨 | 智印雲 ZprintPro",
  ...
  "a2-posters": {
    ...
    "seo": {
      "zh-hk": {
        "title": "A2 海報印刷 | HK$10起/張・防水材質・即日交貨 | 智印雲 ZprintPro",
  ...
  "pvc-menus": {
    ...
    "seo": {
      "zh-hk": {
        ...
        "body": "PVC餐牌 50 本起印。選用250g 銅版紙/防水覆膜，提供4 色 CMYK 全彩印刷、logo 圖案自由設計。下單後5-7 個工作天交貨，港九新界免費速遞。"
      },
      "en": {
