...
export const skuSeoData: Record<string, SkuSeoEntry> = {
  ...
  "small-batch-stickers": {
    ...
    "seo": {
      "zh-hk": {
        "title": "小批量貼紙 50 張起 HK$0.45 | 防水 PVC 異形切割 | 智印港",
      ...
      "ja": {
        "title": "小ロットステッカー 50 枚〜 $0.045 | 防水PVC | ZprintPro",
  ...
  "double-sided-flyers": {
    ...
    "seo": {
      ...
      "ja": {
        "title": "両面カラー印刷 両面チラシ | 100枚〜 | ¥85〜 | ZprintPro",
  ...
  "same-day-flyers": {
    ...
    "seo": {
      ...
      "ja": {
        "title": "即日チラシ印刷｜¥125〜・100枚〜・無料デザイン｜ZprintPro",
