...
export const skuSeoData: Record<string, SkuSeoEntry> = {
  ...
  "a2-posters": {
    ...
    "seo": {
      "zh-hk": {
        "title": "A2 海報印刷 1張起印 HK$10起 即日交貨 印海報一張小訂單適用 | 智印港 ZprintPro",
        "description": "A2 海報印刷 1 張起印、HK$10 起/張，200g 銅版紙 / PP 防水合成紙，Giclée 級 1200 DPI。展覽/門店/地產推廣適用，即日打稿 2 小時。滿 HK$500 免費順豐，30 秒 AI 報價。",
