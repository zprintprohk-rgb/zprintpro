  ...
  "kraft-paper-packaging-box": {
    ...
    "seo": {
      "zh-hk": {
        ...
        "description": "牛皮紙包裝印刷盒 100 個起, 採用 250g-350g 進口牛皮紙, 印刷 Logo 清晰自然, 適合茶葉、月餅、禮品、烘焙產品包裝。48 小時快遞 (順豐香港本地派送)。**智印雲 香港本地印刷 15+ 年自有品牌**: 紙材通過 FSC 環保認證, 100% 可回收, 支持燙金、壓凹、局部光油。",
        "h1": "牛皮紙包裝印刷盒",
  ...
  "fruit-food-label-stickers": {
    ...
    "seo": {
      "zh-hk": {
        ...
        "description": "水果及食品標籤印刷 500 張起, 採用防水 PVC 或 PP 合成紙, 通過 SGS 食品接觸安全認證, 適合水果店、有機食品、烘焙店、外賣包裝。48 小時快遞 (順豐香港本地派送)。**智印雲 香港本地印刷 15+ 年自有品牌**: 耐低溫防霧氣設計, 表面防水防油, 支持可變序號、二維碼。",
        "h1": "水果及食品標籤印刷",
  ...
  "doujinshi-printing": {
    ...
    "seo": {
      "zh-hk": {
        ...
        "description": "同人誌 / Comiket / 即售會專用同人誌印刷。A5/B5 標準尺寸,封面彩色、內頁單色,10 本起印,Comiket 會期前 24 小時特急対応。自営工場 DHL Express 直送日本 2-4 個工作天,繁中客服 + 日文客服雙語支援。",
