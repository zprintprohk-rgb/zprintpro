...
export const coreProductSEO: Record<string, Record<Locale, SEOMetadata>> = {
  stickers: {
    'zh-hk': {
      ...
      canonical: 'https://zprintpro.com/zh-hk/category/stickers/',
      ogImage: 'https://zprintpro.com/images/hero/hero-sticker-zh-hk.webp',
      ogType: 'product',
      locale: 'zh-hk',
    ...
    'en': {
      ...
      canonical: 'https://zprintpro.com/en/category/stickers/',
      ogImage: 'https://zprintpro.com/images/hero/hero-sticker-en.webp',
      ogType: 'product',
      locale: 'en',
    ...
    'ja': {
      ...
      canonical: 'https://zprintpro.com/ja/category/stickers/',
      ogImage: 'https://zprintpro.com/images/hero/hero-sticker-ja.webp',
      ogType: 'product',
      locale: 'ja',
  ...
  flyers: {
    'zh-hk': {
      ...
      canonical: 'https://zprintpro.com/zh-hk/category/flyers/',
      ogImage: 'https://zprintpro.com/images/hero/hero-flyer-zh-hk.webp',
      ogType: 'product',
      locale: 'zh-hk',
    ...
    'en': {
      ...
      canonical: 'https://zprintpro.com/en/category/flyers/',
      ogImage: 'https://zprintpro.com/images/hero/hero-flyer-en.webp',
      ogType: 'product',
      locale: 'en',
    ...
    'ja': {
      ...
      canonical: 'https://zprintpro.com/ja/category/flyers/',
      ogImage: 'https://zprintpro.com/images/hero/hero-flyer-ja.webp',
      ogType: 'product',
      locale: 'ja',
  ...
  'packaging-boxes': {
    'zh-hk': {
      ...
      canonical: 'https://zprintpro.com/zh-hk/category/packaging/',
      ogImage: 'https://zprintpro.com/images/hero/hero-gift-box-zh-hk.webp',
      ogType: 'product',
      locale: 'zh-hk',
    ...
    'en': {
      ...
      canonical: 'https://zprintpro.com/en/category/packaging/',
      ogImage: 'https://zprintpro.com/images/hero/hero-gift-box-en.webp',
      ogType: 'product',
      locale: 'en',
    ...
    'ja': {
      ...
      canonical: 'https://zprintpro.com/ja/category/packaging/',
      ogImage: 'https://zprintpro.com/images/hero/hero-gift-box-ja.webp',
      ogType: 'product',
      locale: 'ja',
  ...
  posters: {
    'zh-hk': {
      ...
      canonical: 'https://zprintpro.com/zh-hk/category/posters/',
      ogImage: 'https://zprintpro.com/images/hero/hero-poster-zh-hk.webp',
      ogType: 'product',
      locale: 'zh-hk',
    ...
    'en': {
      ...
      canonical: 'https://zprintpro.com/en/category/posters/',
      ogImage: 'https://zprintpro.com/images/hero/hero-poster-en.webp',
      ogType: 'product',
      locale: 'en',
    ...
    'ja': {
      ...
      canonical: 'https://zprintpro.com/ja/category/posters/',
      ogImage: 'https://zprintpro.com/images/hero/hero-poster-ja.webp',
      ogType: 'product',
      locale: 'ja',
  ...
  'paper-bags': {
    'zh-hk': {
      ...
      canonical: 'https://zprintpro.com/zh-hk/category/paper-bags/',
      ogImage: 'https://zprintpro.com/images/hero/hero-kraft-bag-zh-hk.webp',
      ogType: 'product',
      locale: 'zh-hk',
    ...
    'en': {
      ...
      canonical: 'https://zprintpro.com/en/category/paper-bags/',
      ogImage: 'https://zprintpro.com/images/hero/hero-kraft-bag-en.webp',
      ogType: 'product',
      locale: 'en',
    ...
    'ja': {
      ...
      canonical: 'https://zprintpro.com/ja/category/paper-bags/',
      ogImage: 'https://zprintpro.com/images/hero/hero-kraft-bag-ja.webp',
      ogType: 'product',
      locale: 'ja',
