...
export const coreProductSEO: Record<string, Record<Locale, SEOMetadata>> = {
  stickers: {
    ...
    'en': {
      title: 'Custom Waterproof Stickers Hong Kong | Die Cut, Clear, Foil | ZprintPro',
      description: 'Premium custom sticker printing in Hong Kong. Waterproof, die cut, clear vinyl, hologram, and foil stickers. Bulk & small orders. International shipping to US/UK/AU.',
      canonical: 'https://zprintpro.com/en/products/stickers',
      ogImage: 'https://zprintpro.com/images/hero/stickers-en.webp',
      ogType: 'product',
      locale: 'en',
      keywords: ['waterproof stickers hong kong', 'die cut stickers custom', 'clear vinyl stickers', 'hologram stickers', 'foil stickers', 'bulk sticker printing', 'sticker packaging'],
    },
    'ja': {
  ...
  flyers: {
    ...
    'en': {
      title: 'Flyer Printing Hong Kong | Same Day A5/A4 Leaflets | ZprintPro',
      description: 'Professional flyer and leaflet printing in Hong Kong. A5/A4, folded, foil-stamped flyers for events and promotions. Same-day pickup available. International shipping to US/UK/AU.',
      canonical: 'https://zprintpro.com/en/products/flyers',
      ogImage: 'https://zprintpro.com/images/hero/flyers-en.webp',
      ogType: 'product',
      locale: 'en',
      keywords: ['flyer printing same day hong kong', 'leaflet printing uk cheap', 'A5 flyer printing', 'foil flyers', 'event flyers hong kong', 'same day leaflet printing'],
    },
    'ja': {
  ...
  'packaging-boxes': {
    ...
    'en': {
      title: 'Custom Packaging Boxes Hong Kong | Rigid, Eco Gift Boxes | ZprintPro',
      description: 'Custom packaging box printing in Hong Kong. Rigid boxes, eco-friendly gift boxes, cosmetic packaging with foil stamping. Same-day sampling. International shipping to US/UK/AU.',
      canonical: 'https://zprintpro.com/en/products/packaging-boxes',
      ogImage: 'https://zprintpro.com/images/hero/packaging-en.webp',
      ogType: 'product',
      locale: 'en',
      keywords: ['rigid box packaging hong kong', 'eco friendly gift boxes uk', 'custom packaging boxes', 'cosmetic box printing', 'gift box wholesale', 'magnetic closure box'],
    },
    'ja': {
  ...
  posters: {
    ...
    'en': {
      title: 'Poster Printing Hong Kong | A2/A1 Outdoor Waterproof | ZprintPro',
      description: 'Professional poster printing in Hong Kong. A2/A1/A0 posters, outdoor waterproof, exhibition backdrops, PP lamination. Same-day pickup available. International shipping to US/UK/AU.',
      canonical: 'https://zprintpro.com/en/products/posters',
      ogImage: 'https://zprintpro.com/images/hero/posters-en.webp',
      ogType: 'product',
      locale: 'en',
      keywords: ['A1 poster printing hong kong', 'outdoor posters australia', 'exhibition backdrop printing', 'waterproof poster printing', 'same day poster hong kong', 'PP laminated posters'],
    },
    'ja': {
  ...
  'paper-bags': {
    ...
    'en': {
      title: 'Custom Paper Bags Hong Kong | Eco Kraft, Gift Bags | ZprintPro',
      description: 'Custom paper bag printing in Hong Kong. Eco-friendly kraft bags, gift bags with foil stamping, retail shopping bags. FSC-certified paper, same-day delivery. International shipping to US/UK/AU.',
      canonical: 'https://zprintpro.com/en/products/paper-bags',
      ogImage: 'https://zprintpro.com/images/hero/paper-bags-en.webp',
      ogType: 'product',
      locale: 'en',
      keywords: ['eco paper bags hong kong wholesale', 'kraft paper bags uk custom', 'custom paper bags', 'gift bag printing', 'retail shopping bags', 'foil stamped paper bags'],
    },
    'ja': {
