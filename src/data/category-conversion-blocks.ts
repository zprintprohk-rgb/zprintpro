...
categoryConversionBlocks['stickers:zh-hk'] = {
  ...
  "quickAnswers": [
    {
      "q": "香港貼紙印刷 1000 張幾錢？",
      "a": "50×50mm 光粉貼紙 1000 張約 HK$200-350，MOQ 低至 100 張，2-3 日出貨。"
    },
    {
      "q": "貼紙印刷最快幾日有貨？",
  ...
  "newFaqs": [
    { "q": "香港貼紙印刷 1000 張幾錢？", "a": "50×50mm 光粉貼紙 1000 張約 HK$200-350，MOQ 低至 100 張，2-3 日出貨，WhatsApp 即時報價。" },
    { "q": "香港最受歡迎貼紙尺寸係邊啲？", "a": "Top5 熱門尺寸：50×50mm、40×60mm、30×30mm、圓形 38mm、70×25mm，全部 100 張起可印。" },
    {
...
categoryConversionBlocks['stickers:ja'] = {
  ...
  "quickAnswers": [
    {
      "q": "ステッカー印刷 1000枚の値段は？",
      "a": "50×50mm 光沢パウダーステッカー 1000枚 約HK$200-350。"
    },
    {
      "q": "ステッカー印刷 納期はどれくらい？",
...
categoryConversionBlocks['flyers:zh-hk'] = {
  ...
  "quickAnswers": [
    ...
    {
      "q": "傳單印刷有咩常用尺寸？",
      "a": "香港最常見係 A4（210×297mm）、A5（148×210mm）、適合唔同派發場景。。"
    },
    {
      "q": "最快幾日可以拎到傳單？",
  ...
  "newFaqs": [
    { "q": "傳單印刷有咩常用尺寸？", "a": "香港最常見係 A4（210×297mm）、A5（148×210mm）、A6（105×148mm）同 DL（99×210mm），適合唔同派發場景。" },
    {
      "q": "印傳單最少要印幾多張？",
...
categoryConversionBlocks['paper-bags:zh-hk'] = {
  ...
  "quickAnswers": [
    ...
    {
      "q": "紙袋訂製有咩常用尺寸？",
      "a": "常見有細碼（約 20×25×8cm）、中碼（約 26×32×10cm）、大碼（約 32×40×12cm）同禮品袋。"
    },
    {
      "q": "訂造紙袋最快幾日有貨？",
    ...
    {
      "q": "邊度有紙袋買？",
      "a": "兩條路：急住用可以去包裝材料店或 Carousell 買現貨即取；要印品牌 Logo／公司名嘅訂製紙袋搵智印港——100 個起印、免費設計打稿、7-12 個工作天交貨、滿 HK$500 免費順豐送港九新界。"
    }
  ],
  "socialProof": [
    {
  ...
  "newFaqs": [
    { "q": "紙袋訂製有咩常用尺寸？", "a": "常見有細碼（約 20×25×8cm）、中碼（約 26×32×10cm）、大碼（約 32×40×12cm）同禮品袋，可按產品尺寸定制。" },
    {
      "q": "紙袋最小可以訂幾多個？",
...
categoryConversionBlocks['paper-bags:ja'] = {
  ...
  "quickAnswers": [
    {
      ...
      "a": "クラフト紙袋は1個￥22〜、白カード紙袋は1個￥28〜、パール紙＋箔押しは1個￥55〜。"
    },
    {
      "q": "紙袋を注文してから届くまで何日かかりますか？",
      "a": "デジタル印刷は標準3-5営業日、オフセット印刷は5-7営業日、特急は2-3営業日で製造します。サンプル確認に2-3日。"
    },
    {
      "q": "紙袋のサイズと材質はどう選べばいいですか？",
      "a": "耐荷重は標準3-5kg、強化タイプは8-10kg。"
    }
  ],
  "socialProof": [
    {
  ...
  "newFaqs": [
    { "q": "オリジナル紙袋の印刷は1個いくらですか？", "a": "クラフト紙袋は1個￥22〜、白カード紙袋は1個￥28〜、パール紙＋箔押しは1個￥55〜。100個からの小ロットに対応し、1,000個以上はオフセット印刷で単価が下がります。最終単価はサイズ・材質・持ち手により変わるため、まずはお見積もりを。" },
    { "q": "紙袋を注文してから届くまで何日かかりますか？", "a": "デジタル印刷は標準3-5営業日、オフセット印刷は5-7営業日、特急は2-3営業日で製造します。サンプル確認に2-3日。完成後はDHL Expressで全世界2-4日、東京・大阪・名古屋など日本全国へお届けします。" },
    { "q": "紙袋のサイズと材質はどう選べばいいですか？", "a": "標準サイズは小（150×80×200mm）・中（220×100×280mm）・大（320×120×380mm）、完全カスタマイズにも対応。材質は発色重視なら白カード紙（250g）、ナチュラル・エコ系ならクラフト紙（200g）、高級感なら黒カード紙＋箔押しが定番です。耐荷重は標準3-5kg、強化タイプは8-10kg。" },
    {
...
categoryConversionBlocks['packaging:ja'] = {
  ...
  "quickAnswers": [
    {
      ...
      "a": "ウエディングボックスは30個〜、カラーボックスは50個〜、標準・工業用は100–200個〜。"
    },
    {
      "q": "クラフト紙でパッケージ印刷はできますか？",
      "a": "可能です。クラフト紙はエコ・オーガニックな印象が魅力で、全箱型でFSC認証エコ紙を選択可能。"
    },
    {
      "q": "食品用パッケージは安全ですか？",
      "a": "はい。食品グレード紙と無毒の大豆インクを使用し、SGS検査済み、日本の食品衛生基準に準拠しています。"
    }
  ],
  "socialProof": [
    {
  ...
  "newFaqs": [
    { "q": "オリジナルパッケージの最小ロットは何個からですか？", "a": "ウエディングボックスは30個〜、カラーボックスは50個〜、標準・工業用は100–200個〜。一般的な工場基準500–1,000個を大きく下回るので、スタートアップの試作や小ロット発注に向いています。" },
    { "q": "クラフト紙でパッケージ印刷はできますか？", "a": "可能です。クラフト紙はエコ・オーガニックな印象が魅力で、全箱型でFSC認証エコ紙を選択可能。有機食品やサステナブルブランドのパッケージに最適で、欧米輸出向けの国際環境基準にも対応します。" },
    { "q": "食品用パッケージは安全ですか？", "a": "はい。食品グレード紙と無毒の大豆インクを使用し、SGS検査済み、日本の食品衛生基準に準拠しています。ベーカリーや健康食品、茶葉用の箱には防湿加工やQRコードの追加も可能です。" },
    {
...
categoryConversionBlocks['calendars:zh-hk'] = {
  ...
  "metaDescription": "香港月曆印刷同月曆訂製一條龍，座枱曆、掛曆、年曆卡、記事簿月曆任揀，燙金年份、局部UV、圓環裝訂都做。1本起訂（數碼），批量300本起上印刷機，月曆價錢掛曆HK$18起、檯曆HK$9起、年曆卡HK$3起，數碼3-5日交貨，順豐到港。2027企業禮品月曆早鳥9折連免費設計，WhatsApp 8619880851334 報價落單搞掂。",
  "quickAnswers": [
    {
      "q": "香港月曆印刷幾多錢？月曆價錢點計？",
      "a": "視乎款式同數量：掛曆 HK$18/本、檯曆 HK$9/本、年曆卡 HK$3/張；"
    },
    {
      "q": "月曆訂製最快幾日有貨？",
      "a": "數碼印刷標準 3-5 日，柯式 5-7 日，急件 2-3 日（數碼）。"
    },
    {
      "q": "月曆最少訂幾多本？有咩尺寸揀？",
      "a": "1 本起訂（數碼印刷），300 本起上印刷機批量更經濟，燙金工藝 100 本起。"
    }
  ],
  "socialProof": [
    {
  ...
  "newFaqs": [
    { "q": "香港月曆印刷幾多錢？月曆價錢點計？", "a": "視乎款式同數量：掛曆 HK$18/本、檯曆 HK$9/本、年曆卡 HK$3/張；500 本柯式企業月曆 HK$10-15/本，燙金另加 HK$0.5-1.5/本（100 本起）。2027 早鳥 9 折連免費設計，實價以 WhatsApp 報價為準。" },
    { "q": "月曆訂製最快幾日有貨？", "a": "數碼印刷標準 3-5 日，柯式 5-7 日，急件 2-3 日（數碼）。11-12 月旺季工廠排期會拉長到 7-10 日，想趕 Q4 交貨建議 9 月中前落單鎖定檔期。" },
    { "q": "月曆最少訂幾多本？有咩尺寸揀？", "a": "1 本起訂（數碼印刷），300 本起上印刷機批量更經濟，燙金工藝 100 本起。座枱曆 150×180 / 200×230mm，掛曆 A3/A2，月曆卡 100×150mm，支援完全訂製。" },
    {
      "q": "2027 月曆幾時開始訂最穩陣？",
...
categoryConversionBlocks['posters:zh-hk'] = {
  ...
  "quickAnswers": [
    {
      "q": "海報印刷幾多錢一張？",
      "a": "128g 銅版紙 A2 約 HK$6-9/張、A1 約 HK$10-16/張（100 張批量價）；"
    },
    {
      "q": "海報有咩 size 同材質揀？",
      "a": "室內揀銅版紙或 PP 合成紙，戶外必須 PVC／帆布／網布，防水抗 UV。"
    },
    {
      "q": "印海報最快幾日有貨？",
      "a": "大圖輸出 1-5 張最快即日交貨，批量標準 1-2 日；柯式批量 3-5 個工作天，DHL 全球 2-4 天到。"
    }
  ],
  "socialProof": [
    {
  ...
  "newFaqs": [
    { "q": "海報印刷幾多錢一張？", "a": "128g 銅版紙 A2 約 HK$6-9/張、A1 約 HK$10-16/張（100 張批量價）；500 張再減 30%，1,000 張以上轉柯式再降約 40%。大圖輸出 1 張都印，實際價錢按尺寸、材質、數量報價。" },
    { "q": "海報有咩 size 同材質揀？", "a": "標準 A2（420×594mm）、A1（594×841mm）、A0（841×1189mm），訂製最大闊 1.5 米、長度不限。室內揀銅版紙或 PP 合成紙，戶外必須 PVC／帆布／網布，防水抗 UV。" },
    { "q": "印海報最快幾日有貨？", "a": "大圖輸出 1-5 張最快即日交貨，批量標準 1-2 日；柯式批量 3-5 個工作天，DHL 全球 2-4 天到。加裱板額外 1 日，趕單可以 WhatsApp 問下加急安排。" },
    {
      "q": "印海報一張幾多錢？",
...
categoryConversionBlocks['posters:en'] = {
  ...
  "quickAnswers": [
    ...
    },
    {
      ...
      "a": "Standard A2 (420×594mm), A1 (594×841mm), A0 (841×1189mm), plus fully custom sizes up to 1.5m wide. Indoor use: 128g art paper, 200g PP synthetic. Outdoor use: 440g PVC hard sheet, canvas or liquid-laminated fabric. All outdoor prints are waterproof。"
    },
    {
  ...
  "newFaqs": [
    { "q": "What poster sizes and materials are available?", "a": "Standard A2 (420×594mm), A1 (594×841mm), A0 (841×1189mm), plus fully custom sizes up to 1.5m wide. Indoor use: 128g art paper, 200g PP synthetic. Outdoor use: 440g PVC hard sheet, canvas or liquid-laminated fabric. All outdoor prints are waterproof, UV-resistant and built to last 2-3 years without fading." },
    {
...
categoryConversionBlocks['posters:ja'] = {
  ...
  "quickAnswers": [
    {
      ...
      "a": "アートペーパー128g A2は125円/枚〜、A1は215円/枚〜、A0は415円/枚〜（100枚オフセット参考価格）。"
    },
    {
      "q": "ポスターのサイズと素材はどう選べばいいですか？",
      "a": "屋内用は128gアートペーパー、200g PP合成紙。屋外印刷は全種防水・UV加工で、色褪せなく2-3年持ちます。"
    },
    {
      "q": "ポスターの最短納期はどのくらいですか？",
      "a": "大口オフセットは1-5枚でも当日発送、標準納期1-2日、カスタムは3-5営業日。"
    }
  ],
  "socialProof": [
    {
  ...
  "newFaqs": [
    { "q": "ポスター印刷の1枚単価はいくらですか？", "a": "アートペーパー128g A2は125円/枚〜、A1は215円/枚〜、A0は415円/枚〜（100枚オフセット参考価格）。500枚でさらに30%オフ、1,000枚以上のオフセットなら最大40%オフ。1枚から大口まで対応、サイズ・素材・数量をWhatsAppでお伝えいただければ、工場直販のお見積もりを即時ご提示します。" },
    { "q": "ポスターのサイズと素材はどう選べばいいですか？", "a": "標準サイズはA2（420×594mm）、A1（594×841mm）、A0（841×1189mm）のほか、最大幅1.5mのフルカスタム対応。屋内用は128gアートペーパー、200g PP合成紙。屋外用は440g PVC硬質シート、キャンバスまたはラミネート加工生地。屋外印刷は全種防水・UV加工で、色褪せなく2-3年持ちます。" },
    { "q": "ポスターの最短納期はどのくらいですか？", "a": "大口オフセットは1-5枚でも当日発送、標準納期1-2日、カスタムは3-5営業日。DHL Expressで世界中2-4日でお届け。ラミネートやパネル貼りなどの加工は+1日。お急ぎの場合はWhatsAppでご相談ください。30%追加料金で24-48時間特急対応も可能です。" },
    {
...
categoryConversionBlocks['calendars:en'] = {
  ...
  "quickAnswers": [
    ...
    },
    {
      ...
      "a": "Standard turnaround is 3-5 days for digital printing and 5-7 days for offset, plus 2-4 business days worldwide via DHL Express / FedEx. For 2027 corporate calendars, order 2-3 months ahead: the August-October ordering window feeds September-December delivery。"
    },
    {
  ...
  "newFaqs": [
    { "q": "How long does calendar printing take, and when should I order 2027 calendars?", "a": "Standard turnaround is 3-5 days for digital printing and 5-7 days for offset, plus 2-4 business days worldwide via DHL Express / FedEx. For 2027 corporate calendars, order 2-3 months ahead: the August-October ordering window feeds September-December delivery, ahead of the November-December factory rush." },
    {
...
categoryConversionBlocks['flyers:ja'] = {
  ...
  "quickAnswers": [
    {
      "q": "チラシ印刷は1枚いくらからですか？",
      "a": "A5片面128gコート紙で1枚¥6〜、両面は1枚¥8〜（両面は+¥1.5／枚）です。"
    },
    {
      "q": "チラシの最小発注数（MOQ）は何枚からですか？",
      "a": "デジタル印刷は100枚から承ります。新店開業やイベントの試し配布にも十分な枚数です。"
    },
    {
  ...
  "newFaqs": [
    { "q": "チラシ印刷は1枚いくらからですか？", "a": "A5片面128gコート紙で1枚¥6〜、両面は1枚¥8〜（両面は+¥1.5／枚）です。枚数が増えるほど単価が下がり、1,000枚以上はオフセット印刷がお得。最終価格はサイズ・紙・数量により変わるため、まずはお見積もりをどうぞ。" },
    { "q": "チラシの最小発注数（MOQ）は何枚からですか？", "a": "デジタル印刷は100枚から承ります。新店開業やイベントの試し配布にも十分な枚数です。1,000枚以上はオフセット印刷に切り替えると単価を抑えられ、大口配布に向いています。" },
    { "q": "チラシはどのくらい早く受け取れますか？", "a": "デジタル印刷は100〜500枚で即日納品が可能です。オフセット印刷は標準2-3営業日で仕上がります。お急ぎの場合は特急対応（+50%料金）もございますので、まずはご相談ください。" },
    {
...
categoryConversionBlocks['menus:zh-hk'] = {
  ...
  "quickAnswers": [
    {
      "q": "餐牌印刷幾多錢？",
      "a": "視乎材質同數量：一次性餐牌 HK$0.22 起/張、過膠餐牌 HK$5 起/張、PVC 膠片餐牌 HK$8 起/張。"
    },
    {
      "q": "咩餐牌先至防水耐用？",
      "a": "PVC 膠片餐牌（0.5–1.0mm）同過膠餐牌都防水防油，湯汁油漬用濕布一抹就淨，啱茶餐廳、火鍋店呢類多油煙場景；"
    },
    {
      "q": "茶餐廳趕住開業換餐牌，最快幾耐有貨？",
      "a": "標準柯式印刷 2–3 個工作天交貨，打樣當日完成對色；"
    }
  ],
  "socialProof": [
    {
  ...
  "newFaqs": [
    { "q": "餐牌印刷幾多錢？", "a": "視乎材質同數量：一次性餐牌 HK$0.22 起/張、過膠餐牌 HK$5 起/張、PVC 膠片餐牌 HK$8 起/張、酒水牌 HK$12 起/張、精裝餐牌 HK$28 起/本，全部 100 張起訂，實際價錢以報價為準。" },
    { "q": "咩餐牌先至防水耐用？", "a": "PVC 膠片餐牌（0.5–1.0mm）同過膠餐牌都防水防油，湯汁油漬用濕布一抹就淨，啱茶餐廳、火鍋店呢類多油煙場景；想檔次高啲可以揀精裝餐牌配硬殼封面。" },
    { "q": "茶餐廳趕住開業換餐牌，最快幾耐有貨？", "a": "標準柯式印刷 2–3 個工作天交貨，打樣當日完成對色；開業或急單記得 WhatsApp 講明死線，我哋有急件專線幫你排期，盡量配合開張日子。" },
    {
      "q": "餐牌真係防水嗎？油漬湯汁抹得走嗎？",
...
categoryConversionBlocks['educational:zh-hk'] = {
  ...
  "quickAnswers": [
    {
      "q": "證書印刷幾多錢一張？",
      "a": "證書 HK$8-40 一張，視乎紙材、尺寸（A4 或 A3）同工藝：燙金、壓凹、防偽底紋、浮水印都可以加。"
    },
    {
      "q": "證書紙有咩材質？點揀先啱？",
      "a": "常見係 200g-250g 水印紙同棉質紙。水印紙本身帶浮水印，加埋防偽底紋就穩陣，機構認證、畢業證書都用得；"
    },
    {
      "q": "校簿印刷起訂量要幾多本？",
  ...
  "newFaqs": [
    { "q": "證書印刷幾多錢一張？", "a": "證書 HK$8-40 一張，視乎紙材、尺寸（A4 或 A3）同工藝：燙金、壓凹、防偽底紋、浮水印都可以加。常用 200g-250g 水印紙或棉質紙，100 張起訂，確實價錢 WhatsApp 報價。" },
    { "q": "證書紙有咩材質？點揀先啱？", "a": "常見係 200g-250g 水印紙同棉質紙。水印紙本身帶浮水印，加埋防偽底紋就穩陣，機構認證、畢業證書都用得；棉質紙手感厚實，寫獎狀、榮譽證書企理啲。唔知點揀就話我哋知用途，幫你配。" },
    { "q": "校簿印刷起訂量要幾多本？", "a": "練習簿 100 本起訂，小批量數碼、大量柯式，補習社同學校細單都接得。A4/A5 內頁可揀橫線、方格或空白，封面 200g 銅版紙四色，HK$4-16/本，開學前兩個星期係高峰期，記得早啲落單。" },
    {
      "q": "證書紙係咩材質？邊種防偽效果好啲？",
...
categoryConversionBlocks['educational:ja'] = {
  ...
  "quickAnswers": [
    ...
    },
    {
      ...
      "a": "表紙はカラー4C＋200gコート紙、内文はモノクロまたは2色。"
    },
    {
      "q": "教材 製本の種類は選べますか？",
      "a": "中綴じ・無線綴じから選択でき、表紙のラミネート加工もオプションで可能です。"
    }
  ],
  "socialProof": [
    {
  ...
  "newFaqs": [
    { "q": "教材 印刷の最小ロットは何部からですか？", "a": "教科書・テキスト・問題集はすべて100部から承ります。問題集・練習帳は1冊￥258〜、教科書は1冊￥1,288〜が目安です。学校や塾の学年内教材など、部数がまとまると単価も下がるため、まずは仕様と部数をお知らせください。最終価格はお見積もり制です。" },
    { "q": "教科書 印刷のサイズと仕様はどう選べばいいですか？", "a": "教科書はA4（210×297mm）またはB5（176×250mm）、問題集・練習帳はA4またはA5（148×210mm）が定番です。表紙はカラー4C＋200gコート紙、内文はモノクロまたは2色。目に優しい80g–100gの上質紙を使い、ISBN・バーコードの掲載にも対応します。" },
    { "q": "教材 製本の種類は選べますか？", "a": "中綴じ・無線綴じから選択でき、表紙のラミネート加工もオプションで可能です。卒業アルバムは上製本に対応し、校章の箔押し・栞紐・ダストジャケットで仕上げます。ページ数・予算・配布シーンに合わせて、教材 印刷 製本の組み合わせをご提案します。" },
    {
...
categoryConversionBlocks['japan-doujin:zh-hk'] = {
  ...
  "metaDescription": "香港同人本印刷／同人印刷推薦：A5/B5 同人誌 10 本起印，封面彩色＋內頁單色，騎馬釘（8-64 頁）／膠裝可選，Comiket 前 24 小時特急對應；仲有明信片套裝、環保托特袋一站式訂製，深圳自營工廠 ISO 12647 色彩管理，DHL 國際速遞出貨，WhatsApp 即時報價。",
  "quickAnswers": [
    {
      "q": "同人本印刷幾多錢？",
      "a": "同人本 10 本起印，價錢視乎開本（A5/B5）、頁數、紙材同裝訂方式，WhatsApp 即時報價。。"
    },
    {
      "q": "同人印刷起訂量係幾多？",
      "a": "同人本 10 本起印；明信片套裝 4 套起；環保托特袋少量起印，社團同個人團隊細批量都印得到。"
    },
    {
      "q": "同人本交期要幾耐？",
      "a": "常規 5-7 個工作天生產，Comiket 前有 24 小時特急對應；"
    }
  ],
  "socialProof": [
    {
      "stat": "10 本起",
      "label": "同人本 10 本起・明信片套裝 4 套起"
    },
    {
      "stat": "24 小時",
      "label": "Comiket 前特急對應"
  ...
  "orderFlow": {
    ...
    "steps": [
      {
        "title": "WhatsApp 查詢",
        "desc": "講明產品：同人本／明信片／環保托特袋，連開本尺寸同數量"
      },
      {
        "title": "報價確認",
        "desc": "2 小時內回覆價錢同交期"
      ...
      {
        "title": "提供設計檔",
        "desc": "AI／PDF／PNG 都收，CMYK 300dpi+，異形圖案要 Illustrator 路徑檔"
      },
      {
        "title": "打樣確認",
  ...
  "newFaqs": [
    { "q": "同人本印刷幾多錢？", "a": "同人本 10 本起印，價錢視乎開本（A5/B5）、頁數、紙材同裝訂方式，50／100／500 本仲有 5%-15% 量購折扣，WhatsApp 即時報價。" },
    { "q": "同人本交期要幾耐？", "a": "常規 5-7 個工作天生產，Comiket 前有 24 小時特急對應；明信片套裝 3-5 個營業日，之後 DHL Express 速遞出貨。" },
    {
      "q": "同人本同普通畫冊印刷有咩分別？",
    ...
    },
    {
      ...
      "a": "同人本常規 5-7 個工作天生產，Comiket 前有 24 小時特急對應，展前高峰期（暑假同年底場次前）廠房排單較密，建議預留 10-15 個工作日會更穩陣，落單前先喺 WhatsApp 確認交期。"
    },
    {
      "q": "可唔可以同人本同周邊一齊落單？",
      "a": "得。同人本、明信片套裝、環保托特袋全部屬同一條 japan-doujin 產品線，深圳自營工廠統一以 ISO 12647 色彩管理，色調一致，一齊出貨方便管理物販。"
    },
    {
      "q": "設計檔有咩要求？",
      "a": "AI／PDF／PNG 都收，建議 CMYK 色彩模式、300dpi 以上；異形圖案需要 Illustrator 路徑檔入稿。印前有免費設計檔檢查，有問題會先同你確認先開印。"
    }
  ]
};
...
categoryConversionBlocks['japan-doujin:ja'] = {
  "category": "japan-doujin",
  "locale": "ja",
  "title": "同人グッズ印刷｜同人誌・ポストカードセット・エコトートバッグ 小ロットから｜ZprintPro",
  "metaDescription": "同人グッズ印刷はお任せ。同人誌1部￥7,500〜、ポストカード1枚￥750〜、エコトートバッグ1個￥9,000〜。10部・4セットからの小ロットに対応し、コミケ前24時間特急製造も可能。AI即時見積もり30秒、DHL Expressで日本全国へ2-4営業日でお届けします。",
  "quickAnswers": [
    {
      "q": "同人グッズの印刷はいくらから依頼できますか？",
      "a": "数量や仕様によって単価が変わるため、最終価格はお見積もり制となります。"
    },
    {
  ...
  "socialProof": [
    {
      "stat": "4セット〜",
      "label": "ポストカードセット・エコトートバッグの小ロットに対応（同人誌は10部から）"
    },
    {
      "stat": "24時間",
      "label": "コミケ前の特急製造に対応（同人誌）"
    },
    {
      "stat": "2-4営業日",
  ...
  "comparisonTable": {
    ...
    "note": "目安価格は同人誌1部￥7,500〜／ポストカード1枚￥750〜／エコトートバッグ1個￥9,000〜。最終価格・納期は仕様と数量により変わるため、お見積もり制です。"
  },
  "orderFlow": {
    "title": "同人グッズ印刷 6ステップ",
    "steps": [
  ...
  "whatsappTemplates": [
    {
      "label": "見積もり依頼",
      "message": "同人グッズの見積もりをお願いします。商品【ポストカードセット】／サイズ【A6】／数量【20セット】／仕様【両面印刷・OPPスリーブ封入】。1個あたりの単価と納期を教えてください。"
    },
    {
      "label": "コミケ特急相談",
    ...
    {
      "label": "リピート追加発注",
      "message": "前に発注した【同じデザインのポストカードセット】を追加したいです。数量【20セット】、デザインは前回と同じです。見積もりをお願いします。"
    }
  ],
  "newFaqs": [
    { "q": "同人グッズの印刷はいくらから依頼できますか？", "a": "同人誌は1部￥7,500〜（10部から）、ポストカードセットは1枚￥750〜（4セットから）、エコトートバッグは1個￥9,000〜（少量から）です。数量や仕様によって単価が変わるため、最終価格はお見積もり制となります。" },
    { "q": "コミケや即売会に間に合う納期はどのくらいですか？", "a": "標準は3-7営業日で製造します。同人誌はコミケ前の24時間特急製造にも対応しています（特急料金はお見積もり制）。完成後はDHL Expressで日本へ2-4営業日でお届けするため、イベント日程はあらかじめお知らせください。" },
    { "q": "ポストカードセットとエコトートバッグはどんな仕様を選べますか？", "a": "ポストカードセットは105×148mm（A6）の和紙風アート紙・両面印刷・OPPスリーブ封入、4-8枚組です。エコトートバッグはオーガニックコットン帆布＋シルク印刷で、少量から対応します。" },
    {
      "q": "小部数でも注文できますか？部数と価格の関係は？",
      "a": "はい。同人誌は10部から、ポストカードセットは4セットから、エコトートバッグは少量から承ります。目安価格は同人誌1部￥7,500〜、ポストカード1枚￥750〜、エコトートバッグ1個￥9,000〜です。部数が増えるほど1点あたりの単価は下がり、最終価格はお見積もり制となります。"
    },
    {
    ...
    {
      "q": "ポストカードセットの枚数や印刷方法は選べますか？",
      "a": "選べます。4-8枚組で枚数を指定でき、両面フルカラー印刷・和紙風アート紙・OPPスリーブ封入に対応します。エコトートバッグはオーガニックコットン帆布へのシルク印刷で、推し活グッズにはポストカードセットとエコトートバッグの組み合わせが人気です。"
    },
    {
      "q": "コミケ前に間に合わせる特急製造は可能ですか？",
      "a": "可能です。同人誌はコミケ前の24時間特急製造に対応しており、標準の3-7営業日より短い納期で製造できます（特急料金はお見積もり制）。完成後はDHL Expressで日本へ2-4営業日でお届けします。イベントの開始日をあらかじめお知らせください。"
    }
  ]
};
categoryConversionBlocks['envelopes:zh-hk'] = {
  "category": "envelopes",
  "locale": "zh-hk",
  "title": "香港信封印刷｜大信封/公文信封/開窗信封訂製 100個起｜智印港",
  "metaDescription": "香港信封印刷訂製：公司信封 HK$0.22 起/個、彩色信封 HK$0.38 起、大號信封 HK$0.60 起、珠光信封 HK$1.15 起，全部 100 個起印。公文信封、牛皮信封、開窗信封、大信封都可以印公司 logo。標準 3-5 個工作天交貨，滿 HK$500 順豐免運，WhatsApp 30 秒報價。",
  "quickAnswers": [
    {
      "q": "信封印刷幾多錢一個？",
      "a": "實際價錢視乎尺寸、紙質同數量，WhatsApp 30 秒就有報價。"
    },
    {
      "q": "邊種信封可以先印公司 logo？",
      "a": "公司信封就係標準公文信封款：logo、地址、合規字樣一體排版，仲會預留郵資區同條碼位；"
    },
    {
      "q": "大信封可以裝 A4 文件嗎？",
      "a": "得。HK$0.60-3.40/個，100 個起印。"
    }
  ],
  "socialProof": [
    {
      "stat": "HK$0.22起",
      "label": "公司信封幾毫一個，月結單、公函大量郵寄都唔肉赤"
    },
    {
      "stat": "100個起印",
      "label": "四款信封劃一 100 個起訂，初創同細企業試版冇壓力"
    },
    {
      "stat": "3-5個工作天",
      "label": "標準交貨期，滿 HK$500 順豐香港免運費"
    },
    {
      "stat": "30秒報價",
      "label": "WhatsApp 講低數量尺寸，好快有價有期"
    }
  ],
  "comparisonTable": {
    "title": "香港信封印刷四款信封 × 材質工藝 × 適用場景 × 價錢比較",
    "columns": [
      "品類",
      "材質/工藝",
      "適用場景",
    ...
    "rows": [
      [
        "公司信封（公文信封）",
        "80–120g 書紙／本白書紙，單色至四色柯式或數碼，自黏封口、開窗貼片可選",
        "寄月結單、公函、發票，適合機械封裝大量郵寄",
        "100 個起・HK$0.22-1.80/個"
      ],
      [
        "彩色信封",
        "80–120g 書紙／彩色書紙，柯式四色＋可選專色，開窗、自黏封口可選",
        "邀請函、賀卡、營銷郵件，可與喜帖卡片同批對色",
        "100 個起・HK$0.38-2.60/個"
      ],
      [
        "大號信封（大信封）",
        "100–120g 書紙為主，C4（229×324mm），可平放 A4 減少摺痕",
        "合約、標書、公文寄遞，多頁文件唔使摺",
        "100 個起・HK$0.60-3.40/個"
      ],
      [
        "珠光信封",
        "珠光／冰白特種書紙，四色／專色＋可選燙金、擊凸，實紙打樣確認珠光走向",
        "婚禮請柬、高端活動卡套，可與喜帖同色系",
        "100 個起・HK$1.15-5.20/個"
      ]
    ],
    "note": "牛皮紙質感、開窗貼片、印郵資區同條碼位等要求，落單時提出都可以安排；實際價錢視乎規格同數量，以 WhatsApp 報價為準。"
  },
  "orderFlow": {
    "title": "6 步信封訂製流程",
    "steps": [
      {
        "title": "WhatsApp 諮詢",
        "desc": "講低信封種類、數量、尺寸（DL／C5／C4），有冇現成設計檔話聲知"
      },
      {
        "title": "30 秒報價",
        "desc": "列明單價、起訂量同交期，急單先講明死線"
      ...
      {
        "title": "設計排版",
        "desc": "提供 logo 同地址資料，免費幫你排靚個版，郵資區條碼位一併預留"
      },
      {
        "title": "打樣對色",
        "desc": "實紙打樣確認顏色、封口位同珠光走向，核對冇問題先開印"
      },
      {
        "title": "落單付款",
        "desc": "轉數快或銀行轉賬，確認後即刻排產"
      },
      {
        "title": "交貨收貨",
        "desc": "標準 3-5 個工作天，滿 HK$500 順豐香港免運費"
      }
    ]
  },
  "whatsappTemplates": [
    {
      "label": "報價查詢",
      "message": "你好，我想印【公司信封】，尺寸【DL】，數量【500】個，印【公司logo同地址】，單色或四色都得，麻煩報價同交期，多謝！"
    },
    {
      "label": "開窗信封查詢",
      "message": "你好，我想查【開窗信封】，用嚟寄【月結單】，窗口位要對準【收件人地址】，數量【1000】個，想知價錢同起訂量，謝謝！"
    },
    {
      "label": "大信封急單",
      "message": "你好，我哋要寄【合約文件】畀客戶，需要【C4大信封】可以平放A4，數量【200】個，【下星期】要交到，想問最快幾日同報價，多謝！"
    }
  ],
  "newFaqs": [
    { "q": "信封印刷幾多錢一個？", "a": "公司信封 HK$0.22 起/個、彩色信封 HK$0.38 起/個、大號信封 HK$0.60 起/個、珠光信封 HK$1.15 起/個，全部 100 個起印；實際價錢視乎尺寸、紙質同數量，WhatsApp 30 秒就有報價。" },
    { "q": "邊種信封可以先印公司 logo？", "a": "公司信封就係標準公文信封款：logo、地址、合規字樣一體排版，仲會預留郵資區同條碼位；80–120g 書紙，DL／C5／C4 規格都齊，仲可以加開窗。HK$0.22-1.80/個，100 個起印。" },
    { "q": "大信封可以裝 A4 文件嗎？", "a": "得。大號信封 C4（229×324mm）可以成張 A4 平放，減少摺痕，100–120g 書紙多頁承重都穩陣，啱裝合約、標書同公文；HK$0.60-3.40/個，100 個起印。" },
    {
      "q": "大信封尺寸點揀？A4 文件要用邊個碼？",
      "a": "寄 A4 文件揀 C4（229×324mm）就可以成張平放，唔使摺；得幾頁紙可以用 C5 對摺放入去。大號信封用 100–120g 書紙，多頁合約標書都承到，HK$0.60-3.40/個，100 個起印。"
    },
    {
      "q": "開窗信封係咩？點解要開窗？",
      "a": "開窗信封係封面上開一個透明貼片窗口，收件人地址預先印喺內頁，就唔使逐個手寫或者貼地址貼紙，機械封裝大量郵寄慳好多工夫。公司信封同彩色信封都可以加開窗，HK$0.22 起/個，100 個起印。"
    },
    {
      "q": "珠光信封可以做婚禮請柬卡套嗎？",
      "a": "好適合。珠光／冰白特種書紙有細膩閃爍質感，配婚禮請柬、晚宴卡套夠晒體面，仲可以加細線燙金或者擊凸提升層次；DL／C5／C4 規格齊，HK$1.15-5.20/個，100 個起印，建議先攞實紙打樣睇珠光走向。"
    },
    {
...
categoryConversionBlocks['red-packets:zh-hk'] = {
  ...
  "locale": "zh-hk",
  "title": "利是封印刷及訂製利是封｜六款工藝 HK$1.10 起｜智印港",
  "metaDescription": "利是封印刷及訂製利是封一站式服務：燙金、浮雕、卡通、環保、大號等六款工藝，可印公司 logo、品牌色同專屬祝福語，適合婚慶喜宴、企業年會及品牌活動；HK$1.10 起/個，100 個起印，免費設計排版，WhatsApp 即時報價，滿 HK$500 順豐香港免運費；新年旺季建議提早落單，急件可傾，以報價為準。",
  "quickAnswers": [
    {
      "q": "利是封印刷幾多錢一個？",
      "a": "實際價格睇數量、紙張同後加工，WhatsApp 就攞到逐款報價。"
    },
    {
      "q": "最少要印幾多個？",
      "a": "六款利是封一律 100 個起印，小批量數碼印刷都接得；"
    },
    {
      "q": "可唔可以印自己個 logo 同公司色？",
      "a": "可以，定製利是封支援 logo、品牌色同專屬圖案，另有燙金、浮雕、異形模切等工藝配搭；"
    }
  ],
  "socialProof": [
    {
      "stat": "ISO 9001",
      "label": "認證印刷廠直出・免費設計排版有據可依"
    },
    {
      "stat": "6 款",
      "label": "燙金、浮雕、卡通、環保、大號、全定製工藝可揀"
    },
    {
      "stat": "100 個",
      "label": "起印門檻，小批量節令單都接"
  ...
  "comparisonTable": {
    ...
    "rows": [
      [
        ...
        "全客製四色印刷＋燙金/UV，免費刀模",
        "企業派發、品牌活動、節日營銷",
        "100 個起印／HK$1.90-6.40/個"
      ],
      [
        "燙金利是封",
        "傳統燙金，多款吉祥圖案或專屬設計",
        "婚慶喜宴、企業年會、客戶禮贈",
        "100 個起印／HK$1.10-4.80/個"
      ],
      [
        "浮雕利是封",
        "0.3–0.5mm 浮雕壓紋，立體觸感",
        "VIP 客戶、高端送禮、酒店迎賓",
        "100 個起印／HK$3.00-9.50/個"
      ],
      [
        "卡通利是封",
        "四色數碼印刷，活潑卡通圖案",
        "親子品牌、教育機構、兒童產品",
        "100 個起印／HK$1.10-3.80/個"
      ],
      [
        "環保利是封",
        "FSC 再生紙／種子紙＋大豆油墨，無覆膜",
        "注重環保的企業、可持續主題活動",
        "100 個起印／HK$1.90-5.20/個"
      ],
      [
        "大號利是封",
        "加大 30%–50% 容量，燙金/浮雕可選",
        "厚禮金、禮品卡、送禮場合",
        "100 個起印／HK$2.20-7.50/個"
      ]
    ]
  },
  "orderFlow": {
    "steps": [
      {
        "title": "揀款式",
        "desc": "六款利是封揀啱心水，定唔到就直接講需求同預算"
      },
      {
        "title": "WhatsApp 報價",
        "desc": "話我哋知【數量】同工藝要求，攞實價同貨期"
      },
      {
        "title": "免費設計排版",
        "desc": "冇現成檔案都做得，設計師幫手排靚版"
      },
      {
        "title": "確認稿",
        "desc": "核對色稿、字體同刀模細節，確認先開機生產"
      },
      {
        "title": "生產同檢查",
        "desc": "柯式或數碼生產，工藝逐批檢查"
      ...
      {
        "title": "順豐香港配送",
        "desc": "滿 HK$500 免運費，新年急件可傾，以報價為準"
      }
    ],
    "title": "利是封訂製 6 步流程"
  },
  "whatsappTemplates": [
    {
      "label": "報價查詢",
      "message": "你好！我想查詢【款式】利是封報價，預計印【數量】個，想加公司 logo 同祝福語，麻煩報埋價同貨期，唔該！"
    },
    {
      "label": "新年急單",
      "message": "Hello，新年急單：需要【款式】利是封【數量】個，想趕得切年前收貨，請問而家落單出唔出到？"
    },
    {
      "label": "設計檔案檢查",
      "message": "想訂【款式】利是封【數量】個，我哋有自己嘅設計檔案，可以幫手檢查埋 CMYK 色值同出血位嗎？"
    }
  ],
  "newFaqs": [
    { "q": "利是封印刷幾多錢一個？", "a": "視乎款式同工藝：燙金利是封同卡通利是封 HK$1.10 起，定製利是封同環保利是封 HK$1.90 起，大號利是封 HK$2.20 起，浮雕利是封 HK$3.00 起；實際價格睇數量、紙張同後加工，WhatsApp 就攞到逐款報價。" },
    { "q": "最少要印幾多個？", "a": "六款利是封一律 100 個起印，小批量數碼印刷都接得；數量上去有分層報價，直接 WhatsApp 話我哋知數量同款式就計到。" },
    { "q": "可唔可以印自己個 logo 同公司色？", "a": "可以，定製利是封支援 logo、品牌色同專屬圖案，另有燙金、浮雕、異形模切等工藝配搭；唔識設計都唔使驚，免費設計排版幫你執好個檔。" },
    {
      "q": "利是封印刷幾多錢？",
      "a": "全部明碼標價：燙金利是封 HK$1.10-4.80/個、卡通利是封 HK$1.10-3.80/個、定製利是封 HK$1.90-6.40/個、環保利是封 HK$1.90-5.20/個、大號利是封 HK$2.20-7.50/個、浮雕利是封 HK$3.00-9.50/個；一律 100 個起印，實際單價按數量同工藝計，WhatsApp 攞報價。"
    },
    {
      "q": "趕新年貨期，幾時落單先趕得切？",
      "a": "利是封係節令貨，農曆新年前 3 週係接單高峰期，建議提早落單預留檔期；急件可以傾，實際交期同安排以報價為準。"
    },
    {
      "q": "設計檔案有咩要求？",
      "a": "建議提供 CMYK 色值、預留出血位嘅可編輯檔案；如果只有圖片或者想改字改色，交俾我哋免費設計排版處理就得。"
    },
    {
      "q": "利是封用咩紙？",
      "a": "主流款式用 120g–150g 紅色紙張，大號款用 150g–200g 更挺身；卡通款另有銅版紙，環保款揀 FSC 再生紙或種子紙配大豆油墨。"
    }
  ]
};
  ...
  "quickAnswers": [
    {
      ...
      "a": "ページ数・紙質・製本方法によって単価が変わるため、最終価格はお見積もり制となります。"
    },
    {
