...
categoryConversionBlocks['envelopes:zh-hk'] = {
  ...
  "quickAnswers": [
    {
      "q": "信封印刷幾多錢一個？",
      "a": "公司信封 HK$0.22 起/個、彩色信封 HK$0.38 起/個、大號信封 HK$0.60 起/個、珠光信封 HK$1.15 起/個，全部 100 個起印；實際價錢視乎尺寸、紙質同數量，WhatsApp 30 秒就有報價。"
    },
    {
      "q": "邊種信封可以先印公司 logo？",
      "a": "公司信封就係標準公文信封款：logo、地址、合規字樣一體排版，仲會預留郵資區同條碼位；80–120g 書紙，DL／C5／C4 規格都齊，仲可以加開窗。HK$0.22-1.80/個，100 個起印。"
    },
    {
      "q": "大信封可以裝 A4 文件嗎？",
      "a": "得。大號信封 C4（229×324mm）可以成張 A4 平放，減少摺痕，100–120g 書紙多頁承重都穩陣，啱裝合約、標書同公文；HK$0.60-3.40/個，100 個起印。"
    }
  ],
  "socialProof": [
    {
...
categoryConversionBlocks['red-packets:zh-hk'] = {
  ...
  "quickAnswers": [
    {
      "q": "利是封印刷幾多錢一個？",
      "a": "視乎款式同工藝：燙金利是封同卡通利是封 HK$1.10 起，定製利是封同環保利是封 HK$1.90 起，大號利是封 HK$2.20 起，浮雕利是封 HK$3.00 起；實際價格睇數量、紙張同後加工，WhatsApp 就攞到逐款報價。"
    },
    {
      "q": "最少要印幾多個？",
      "a": "六款利是封一律 100 個起印，小批量數碼印刷都接得；數量上去有分層報價，直接 WhatsApp 話我哋知數量同款式就計到。"
    },
    {
      "q": "可唔可以印自己個 logo 同公司色？",
      "a": "可以，定製利是封支援 logo、品牌色同專屬圖案，另有燙金、浮雕、異形模切等工藝配搭；唔識設計都唔使驚，免費設計排版幫你執好個檔。"
    }
  ],
  "socialProof": [
    {
