...
categoryConversionBlocks['japan-doujin:zh-hk'] = {
  ...
  "newFaqs": [
    ...
    { "q": "同人本交期要幾耐？", "a": "常規 5-7 個工作天生產，Comiket 前有 24 小時特急對應；匙扣、襟章特急 3 個營業日，明信片套裝 3-5 個營業日，之後 DHL Express 速遞出貨。" },
    {
      "q": "同人本同普通畫冊印刷有咩分別？",
...
categoryConversionBlocks['japan-doujin:ja'] = {
  ...
  "quickAnswers": [
    ...
    },
    {
      ...
      "a": "缶バッジは57mm／76mmの2サイズで、フルカラー印刷・安全ピン付きが標準です。"
    }
  ],
  "socialProof": [
    {
  ...
  "newFaqs": [
    { "q": "同人グッズの印刷はいくらから依頼できますか？", "a": "同人誌は1部￥7,500〜（10部から）、アクリルキーホルダーは1個￥2,275〜、缶バッジは1個￥1,200〜（各10個から）、ポストカードセットは1枚￥750〜（4セットから）です。数量や仕様によって単価が変わるため、最終価格はお見積もり制となります。" },
    { "q": "コミケや即売会に間に合う納期はどのくらいですか？", "a": "標準は3-7営業日で製造します。同人誌と缶バッジはコミケ前の24時間特急製造にも対応しています（特急料金はお見積もり制）。完成後はDHL Expressで日本へ2-4営業日でお届けするため、イベント日程はあらかじめお知らせください。" },
    { "q": "アクリルキーホルダーと缶バッジはどんな仕様を選べますか？", "a": "アクリルキーホルダーは30-80mmの任意形状、2mm／3mmの厚み、透明・白・満版印刷から選べ、安全ピンやチェーンのオプションも可能です。缶バッジは57mm／76mmの2サイズで、フルカラー印刷・安全ピン付きが標準です。" },
    {
