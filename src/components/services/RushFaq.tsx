  ...
  const dict = {
    'zh-hk': {
      ...
      faqs: [
        ...
        { q: '點樣收貨？', a: '順豐送貨上門或合作點交收都得，我哋冇門市自取，落單時揀啱收貨方式即可。' },
    ...
    en: {
      ...
      faqs: [
        ...
        { q: 'How do I receive?', a: 'SF Express door-to-door or partner location pickup. No storefront self-pickup, choose your delivery method at order time.' },
    ...
    ja: {
      ...
      faqs: [
        ...
        { q: '配送方法は？', a: 'SF配送または提携先受取。店舗受取はございません、ご注文時にお選びください。' },
