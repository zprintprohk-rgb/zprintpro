...
const pillarData: Record<string, {
  ...
  'business-cards': {
    'zh-hk': {
      h2: '香港名片印刷完全指南',
      paragraphs: [
        '在香港這個國際商業中心，一張精心設計的名片不僅是聯繫方式，更是品牌形象的第一印象。智印云提供全港最專業的名片印刷服務，從標準商務名片到高級燙金名片，滿足不同行業和場合的需求。',
        ...
        '無論您是初創企業、自由工作者還是跨國公司，智印云都能為您提供量身定制的名片解決方案。立即上傳設計稿或選擇我們的免費模板，開始打造專屬於您的商務名片。',
      ],
      faq: [
  ...
  'stickers': {
    'zh-hk': {
      ...
      paragraphs: [
        '貼紙是現代商業不可或缺的宣傳工具。無論是產品標籤、品牌貼紙還是活動宣傳，智印云都能提供專業的貼紙印刷解決方案。我們的貼紙採用PP合成紙、PVC、PET等優質材料，配合UV固化油墨，確保防水、防曬、防撕裂。',
  ...
  'flyers': {
    'zh-hk': {
      ...
      paragraphs: [
        '宣傳單張是最直接、最有效的線下推廣工具。智印云提供全港最具性價比的宣傳單張印刷服務，A4/A5/DL尺寸，光粉紙/啞粉紙/書紙多種紙質選擇。無論是開業宣傳、活動推廣、餐廳Menu還是選舉文宣，我們都能快速高質完成。',
  ...
  'packaging': {
    'zh-hk': {
      ...
      paragraphs: [
        '包裝盒是品牌的無聲推銷員。一個精心設計的包裝盒不僅能保護產品，更能提升品牌價值和顧客體驗。智印云提供專業的包裝盒定制服務，從禮品盒、化妝品盒到食品盒，滿足各行各業的需求。',
  ...
  'posters': {
    'zh-hk': {
      ...
      paragraphs: [
        '海報是視覺傳播的王者。無論是商業展覽、活動宣傳、零售促銷還是家居裝飾，一張高品質的海報都能瞬間抓住眼球。智印云提供全港最專業的海報印刷服務，A0/A1/A2/A3全尺寸覆蓋，滿足各種場景需求。',
  ...
  'paper-bags': {
    'zh-hk': {
      ...
      paragraphs: [
        '在環保意識日益增強的今天，紙袋已成為零售、餐飲和活動的首選包裝。智印云提供專業的紙袋印刷服務，從簡約的牛皮紙袋到奢華的禮品袋，滿足各種品牌定位需求。',
...
function getDefaultPillar(categorySlug: string, locale: string) {
  ...
  return {
    ...
    paragraphs: [locale === 'zh-hk' ? `智印云提供專業的${name}服務，品質保證，價格透明。` : locale === 'en' ? `ZprintPro offers professional ${name} services with quality guarantee.` : `ZprintProはプロの${name}サービスを提供します。`],
    faq: [],
  };
}
