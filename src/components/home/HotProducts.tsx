          ...
          <div className="hidden lg:block w-56 flex-shrink-0 relative left-[-5px] space-y-4">
            ...
            <div className="bg-gradient-to-br from-[#2873F5] to-[#1E5FD1] rounded-2xl p-5 md:p-6 pb-6 md:pb-7 text-white">
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 w-full px-4 py-2.5 border-2 border-white/50 text-white rounded-xl text-base font-medium hover:bg-white/15 transition-colors mb-4"
              >
