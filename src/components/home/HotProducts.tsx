                  ...
                  return (
                    ...
                    >
                      <span className="flex items-center gap-2.5">
                        <span className={isEducational ? 'text-gray-400' : 'text-gray-400'}>{categoryIcons[cat.slug] || <ShoppingBag className="w-4 h-4" />}</span>
                        <span>{locale === 'zh-hk' ? cat.name : locale === 'en' ? cat.nameEn : cat.nameJa}</span>
                      </span>
                      <span className={`flex items-center gap-1 text-sm ${isEducational ? 'text-gray-400' : 'text-gray-400'}`}>
