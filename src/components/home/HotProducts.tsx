        ...
        <div className="flex gap-6 items-start">
          ...
          <div className="hidden lg:block w-56 flex-shrink-0 relative left-[-5px] space-y-4">
            ...
            <div className="bg-gradient-to-br from-[#2873F5] to-[#1E5FD1] rounded-2xl p-5 md:p-6 pb-6 md:pb-7 text-white">
              <h3 className="font-bold text-lg md:text-xl mb-2.5 text-center">{t.enterpriseCta}</h3>
              <p className="text-white/80 text-sm mb-4 text-center leading-relaxed">{t.enterpriseDesc}</p>
              <Link
                href={`${localePrefix}/contact/`}
                className="flex items-center justify-center w-full text-[#2873F5] text-base font-semibold bg-white hover:bg-gray-50 px-4 py-2.5 rounded-xl transition-colors mb-3.5 shadow-lg"
              >
                {t.contactUs}
              </Link>
              <a
                ...
                className="flex items-center justify-center gap-2 w-full px-4 py-2.5 border-2 border-white/50 text-white rounded-xl text-base font-medium hover:bg-white/15 transition-colors mb-5"
              >
              ...
              <div className="text-center pt-2.5 border-t border-white/20">
