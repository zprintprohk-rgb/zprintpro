...
const MATERIALS: Material[] = [
  {
    ...
    cost: { 'zh-hk': 'HK$0.55-2.20/張', en: 'US$0.07-0.28/pc', ja: 'HK$0.55-2.20/枚' },
  ...
  },
  {
    ...
    cost: { 'zh-hk': 'HK$0.38-1.50/張', en: 'US$0.05-0.19/pc', ja: 'HK$0.38-1.50/枚' },
  ...
  },
  {
    ...
    waterproof: { 'zh-hk': '⭐⭐', en: '⭐⭐', ja: '⭐⭐' },
    sun: { 'zh-hk': '⭐⭐ 室內為主', en: '⭐⭐ Indoor mainly', ja: '⭐⭐ 室内向け' },
    cost: { 'zh-hk': 'HK$0.30-1.00/張', en: 'US$0.04-0.13/pc', ja: 'HK$0.30-1.00/枚' },
