        ...
        <div className="bg-gray-50 border-b border-gray-100">
          <div className="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center text-sm sm:text-base py-2.5">
            ...
            <div className="flex items-center text-gray-700 font-medium">
              <a href={`tel:${t.phone.replace(/\D/g, '')}`} className="flex items-center gap-2 hover:text-[#2873F5] transition-colors pl-1 pr-4 border-r border-gray-300">
            ...
            <div className="flex items-center gap-4">
              ...
              <a {...getWhatsAppLinkProps(locale, { source: 'header-top' })} className="flex items-center gap-2 text-green-600 hover:text-green-700 font-semibold transition-colors">
              ...
              <div className="flex items-center gap-1 pl-3 border-l border-gray-300">
