  ...
  'zh-hk': [
    {
      ...
      a: '每日18:00（週一至週五）前完成付款並確認稿件，即可安排通宵印刷。傳單印刷、海報、貼紙、贴纸、畫冊與易拉寶均於翌日中午12點前送達。支持港鐵站交收及辦公室地址配送。',
    },
    {
      q: '週五晚上下單，週一中午能收到嗎？',
    ...
    {
      q: '送貨範圍覆蓋哪些地區？',
      a: '全港覆蓋：九龍（旺角、觀塘、尖沙咀）、港島（中環、銅鑼灣、灣仔）及新界（荃灣、沙田、屯門）。可選港鐵站交收（免運費）或上門速遞——交收點為香港服務點，非生產地。',
    },
    {
      q: '如果明天中午沒收到怎麼辦？',
