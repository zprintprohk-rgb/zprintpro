  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-gradient-to-br from-[#2873F5] to-[#1E5FD1] rounded-lg p-4 text-white">
        <h3 className="font-semibold text-sm mb-3 text-center">{t.contactUs}</h3>
        <a
          href="https://wa.me/85290616204"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center gap-2 w-full px-3 py-2 bg-white text-[#2873F5] rounded-lg text-sm font-medium hover:bg-gray-100 transition-colors mb-3"
        >
        ...
        <div className="text-center">
          <p className="text-xs text-white/70">{t.serviceHours}</p>
