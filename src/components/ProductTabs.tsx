...
const specsByCategory: Record<string, {
  ...
  'business-cards': {
    ...
    size: { 'zh-hk': '90×54mm（標準）', en: '90×54mm (Standard)', ja: '90×54mm（標準）' },
  ...
  'paper-bags': {
    material: { 'zh-hk': '牛皮紙 / 白卡紙 / 環保紙', en: 'Kraft / White Card / Eco Paper', ja: 'クラフト/白カード/エコ紙' },
    size: { 'zh-hk': '多種尺寸可選', en: 'Multiple sizes', ja: '複数サイズ' },
    finish: { 'zh-hk': '燙金/UV/凹凸', en: 'Foil/UV/Emboss', ja: '箔押し/UV/エンボス' },
  },
  'flyers': {
    material: { 'zh-hk': '128g-250g 銅版紙', en: '128g-250g Art Paper', ja: '128g-250g コート紙' },
    size: { 'zh-hk': 'A4(210×297mm) / A5 / A3', en: 'A4(210×297mm) / A5 / A3', ja: 'A4(210×297mm) / A5 / A3' },
  ...
  'posters': {
    ...
    size: { 'zh-hk': 'A2 / A1 / A0 / 自定', en: 'A2 / A1 / A0 / Custom', ja: 'A2 / A1 / A0 / カスタム' },
  ...
  'calendars': {
    ...
    size: { 'zh-hk': 'A4 / A3 / 自定', en: 'A4 / A3 / Custom', ja: 'A4 / A3 / カスタム' },
    finish: { 'zh-hk': '騎馬釘/圈裝/膠裝', en: 'Saddle Stitch/Spiral/Perfect Bound', ja: '中綴じ/スパイラル/無線綴じ' },
  },
  'menus': {
    material: { 'zh-hk': 'PVC / 157g銅版紙 / 過膠', en: 'PVC / 157g Art Paper / Laminated', ja: 'PVC / 157gコート紙 / ラミネート' },
    size: { 'zh-hk': 'A4 / A5 / 三折', en: 'A4 / A5 / Trifold', ja: 'A4 / A5 / 三つ折り' },
  ...
  'banners': {
    ...
    size: { 'zh-hk': '按平方米計算', en: 'Per square meter', ja: '平方メートル単位' },
  ...
  'books': {
    ...
    size: { 'zh-hk': 'A4 / A5 / B5 / 自定', en: 'A4 / A5 / B5 / Custom', ja: 'A4 / A5 / B5 / カスタム' },
  ...
  'envelopes': {
    ...
    size: { 'zh-hk': 'DL / C5 / C4 / 自定', en: 'DL / C5 / C4 / Custom', ja: 'DL / C5 / C4 / カスタム' },
...
export function ProductTabs({ product, locale }: ProductTabsProps) {
  ...
  const getFeatures = () => {
    const map: Record<string, string[][]> = {
      'business-cards': ['zh-hk,高品質四色印刷,多種紙張可選,即日交貨服務,免費設計諮詢'.split(','), 'en,High-quality 4C printing,Multiple paper options,Same-day delivery,Free design consultation'.split(','), 'ja,高品質4色印刷,複数の紙種選択可,即日納品サービス,無料デザイン相談'.split(',')],
      'flyers': ['zh-hk,標準A4/A5尺寸,157g銅版紙,色彩鮮豔飽滿,適合大量派發'.split(','), 'en,Standard A4/A5 sizes,157g art paper,Vibrant color saturation,Perfect for mass distribution'.split(','), 'ja,標準A4/A5サイズ,157gコート紙,鮮やかな色彩,大量配布に最適'.split(',')],
    };
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-600">
                {locale === 'zh-hk'
                  ...
                  : locale === 'en'
                  ? 'We offer multiple shipping options including SF Express, local courier, and store pickup. Kwun Tong factory MTR pickup available.'
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-600">
                {locale === 'zh-hk'
                  ...
                  : locale === 'en'
                  ? 'Free shipping for orders over HK$500 (Hong Kong area). Outlying islands may incur additional charges.'
