const posterBreadcrumb = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "海報印刷｜A2/A3/A1多尺寸", "item": "https://zprintpro.com/zh-hk/services/poster-printing" }
  ]
};
  ...
  return (
    <>
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <h1 className="text-3xl font-bold mb-6">海報印刷｜A2/A3/A1多尺寸</h1>
        <div className="mt-8">
