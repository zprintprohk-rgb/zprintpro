...
> ### ⚠️ 统一发现入口（2026-09-20 追加）
> 本文档为**并发会话**产出。同日另一会话另建了交生活书 —— 两者**互为指针，均为有效产物**，非二选一。
> **新接手者请先读**：`docs/2026-09-20-handover-living-book.md`（**唯一入口**，其 §0 登记全部同族产物）。
> 本文件专注 **12 段骨架 / 门禁加固 / B2-B3 内容批次**；活书专注**状态快照 / 规则 SSoT / 并发协议**。
> **正文合并留待安全窗口**（见活书 §0 阶段 2），当前以指针互认。
