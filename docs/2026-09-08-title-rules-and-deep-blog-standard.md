...
| 3-5 | **H2/H3 问句段群** | **(H2+H3)** 总量 6-10 个；其中**问句式 >50%**（多少/怎樣/如何/how/what/いくら/どう）。**主段锚可为 H2 或 H3**（K3 2026-09-19 决策 方案 a：关键在「层级逻辑清晰」，不强求 H2；外部研究：有清晰 H1-H2-H3 层级的页面被 ChatGPT 引用概率约为无层级页面的 3 倍）；每段正文 ≤3 行 |
