...
- ⇒ **答案长度改写口径（K3 2026-09-19 修订为 40-120 词）**：外部研究给出两段区间 —— **40-80 词**是 AI 引擎（Perplexity / ChatGPT）**引用效果最佳**的「答案胶囊」区间（契合其段落级提取逻辑）；80-150 词提供更多上下文深度。故**最终口径 = 40-120 词**（下限对齐高引用区间，上限保留深度空间；旧口径 80-150 词偏高）。
  新写/补写 FAQ（B3 foil 批）按 **40-120 词**执行；**存量已写 FAQ 不动**（churn 红线），仅在字数升级批次顺带扩写。
