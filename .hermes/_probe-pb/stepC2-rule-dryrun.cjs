...
const RULES = [
  ...
  [EN, /FSC\s*認證紙\s*certified/g, 'FSC-certified paper', '消费前缀 FSC + 尾部 certified'],
  [EN, /FSC\s*認證紙\s*Certification/g, 'FSC chain-of-custody certification', '消费前缀 FSC + Certification 尾'],
  [EN, /FSC\s*認證紙/g, 'FSC-certified paper', '消费前缀 FSC (防 FSC FSC-certified 重复)'],
  [EN, /認證紙/g, 'certified paper', '兜底 (无 FSC 前缀时)'],
