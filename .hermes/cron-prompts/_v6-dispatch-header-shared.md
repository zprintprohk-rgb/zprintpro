[v6.3 派发段已落盘 .hermes/cron-prompts/{name}.md v9.6/v1.4/v7 完整升级段 (K3 8/30 20:00 + 9/1 02:54 + 9/1 02:58 三轮拍板, 5 cron 共享同步), git push 待 §0.25 30 min 间隔 + §0.25.9 攒批] 你是 zprintpro-nextjs (智印港 / ZprintPro) cron 专员 v6.1.
...
【v6.1 → v6.3 升级段 (K3 9/1 09:46 派活包, 5 cron 共享同步, 必读)】K3 9/1 09:46 派活包原文: "D 7 篇选题 D8-D14 立即启动 + E ToB SOP D25 启动 + 新版标题规则写进技能 + 同步更新定时任务指令"
...
- 5 cron SSoT v6.1 = 2bdacde3 9/1 03:30 落, v6.3 升级同步 (1 commit 攒批 push)
