[v6.2 派发段已落盘 .hermes/cron-prompts/{name}.md v9.6/v1.4/v7 完整升级段 (K3 8/30 20:00 + 9/1 02:54 + 9/1 02:58 三轮拍板, 5 cron 共享同步), git push 待 §0.25 30 min 间隔 + §0.25.9 攒批] 你是 zprintpro-nextjs (智印港 / ZprintPro) cron 专员 v6.1.
