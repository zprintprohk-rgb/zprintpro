...
4. **蚕食检测**: 与现有 85 blog entries 哪些主题重复? (per blog-posts.ts SSoT, 重复率 > 50% = 砍掉换新, per Animalz refresh)
...
- **9 月首单**: **85 blog entries 盘点** → 4 档分布 → 翻新配额 4-6 篇/月 (per blog-posts.ts SSoT, K3 9/1 16:22 派活包核对真实数据, 纠正 K3 9/1 15:59 派活包"94 篇"估算 + K3 9/1 16:16 派活包"79 unique"近似估算)
- **9/1 16:30 (立即起跑, K3 派活包"时不我待")**: 85 blog entries 盘点 (worker 异步) → 4 档分布 + 14 项 3 locale 同步差修复清单 → 选题库改排期
