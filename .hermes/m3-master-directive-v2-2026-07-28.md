...
<script type="application/ld+json">
{
  ...
  "image": "https://zprintpro.com/images/{{SLUG}}-og.jpg",
  "url": "https://zprintpro.com/{{LOCALE}}/products/{{SLUG}}",
  "brand": {
    "@type": "Brand",
    "name": "ZPrintPro"
  },
...
<script type="application/ld+json">
{
  ...
  "description": "Custom printing service for greeting cards, business cards, workbooks, and educational materials. Serving USA, Japan, and Hong Kong.",
...
表格
#	页面	类型	Locale	Slug
1	校园印刷类目页	类目 hero	zh-hk	/zh-hk/campus-printing
2	Back-to-School Printing Guide	博客	en	/blog/back-to-school-printing-guide
3	夏休み明け印刷ガイド	博客	ja	/blog/natsuyasumi-ake-insatsu-guide
...
表格
来源页	链接到	锚文本示例
校园类目页 (zh-hk)	/zh-hk/products/premium-greeting-cards	"定制賀卡印刷"
校园类目页 (zh-hk)	/zh-hk/products/workbook-printing	"練習冊印刷"
EN 博客	/products/premium-greeting-cards	"custom greeting card printing"
EN 博客	/products/workbook-printing	"workbook printing service"
JA 博客	/ja/products/premium-greeting-cards	"年賀状印刷"
JA 博客	/ja/products/workbook-printing	"ワークブック印刷"
每条内链写入前必须 curl -sI 验证 200。
...
# 验证目标 URL 返回 200
curl -sI "https://zprintpro.com/{{LOCALE}}/products/{{SLUG}}" | head -1
# 期望: HTTP/2 200

# 如果不是 200，跳过该链接，报告标注:
# "SKIP: /xx/products/yy returned {STATUS}"
§12 报告格式规范（K3 格式）
所有报告统一结构：
markdown
