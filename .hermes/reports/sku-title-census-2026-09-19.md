...
```json
{
 ...
 "recountMismatch": 0,
 "ruleDeltaOkOnlyUnderNewRule": 65,
 "withGscRows": 260,
 "issueSlots": 40
}
```
...
| eco-flyers | ja | 46 | 1 | 4.00 | 0.00% | flyers | エコチラシ | 両面フルカラー 10枚〜 | ZprintPro |
...
- v4 旧口径分布: {"LEGACY":72,"OK":193,"FILL":25,"RED":10}
- 现行口径分布: {"OK":258,"FILL":25,"TRIM":17}
- **仅因新口径 (50-57) 才判达标**的槽位: 65 条 (旧口径下属 55-57 由「满格禁加」变为「合规」; ≥58 仍为阻断线)
...
| ja | ZprintPro | 41 | 52/53/50/54/51 | kraft-paper-bags, gift-bags, handle-bags, outdoor-posters, display-posters, art-posters, cosmetic-boxes, folding-boxes, embossed-red-packets, cartoon-red-packets, eco-red-packets, adhesive-banners, catalog-printing, saddle-stitch-booklets, perfect-bound-books, certificates, school-flyers, electronics-packaging-box, kraft-paper-packaging-box, doujinshi-printing, can-badge, postcard-set, premium-greeting-cards, spot-uv-greeting-cards, matte-greeting-cards, rounded-corner-greeting-cards, cafe-table-cards, corrugated-boxes, drink-tokens, escort-cards, foil-wedding-invitations, name-tags-badges, save-the-date-cards, tuck-end-boxes, wedding-menu-cards, wedding-place-cards, wedding-program-cards, wedding-seating-charts, wedding-suite-bundle, wedding-thank-you-cards, white-card-boxes |
| en | Free Shipping $99+ | ZprintPro | 34 | 56/53/57/55/54/51/52/49/50/48 | die-cut-stickers, foil-stickers, security-stickers, kraft-paper-bags, white-card-bags, gift-bags, eco-paper-bags, handle-bags, small-bags, large-bags, double-sided-flyers, thick-paper-flyers, a2-posters, a1-posters, outdoor-posters, display-posters, art-posters, cosmetic-boxes, mailer-boxes, folding-boxes, rigid-boxes, embossed-red-packets, custom-red-packets, cartoon-red-packets, custom-calendars, photo-frame-calendars, magnetic-calendars, outdoor-vinyl-banners, saddle-stitch-booklets, business-envelopes, colored-envelopes, pearl-envelopes, acrylic-keychain, can-badge |
...
| en | Free Ship $99+ | ZprintPro | 5 | 54 | removable-stickers, adhesive-posters, magnetic-closure-gift-box, electronics-packaging-box, kraft-paper-packaging-box |
| en | Perfect Bound | Free US Ship | ZprintPro | 4 | 62/59/57/52 | perfect-bound-books, spiral-notebooks, exercise-books, textbooks |

## H. 违规清单 ledger (黄灯期跟踪 · K3 2026-09-19 指令)

- ledger: `.hermes/reports/sku-title-ledger.json` (稳定键 slug|locale, 记 firstSeen / 当量历史 / status)
- **未修复 42** / 已修复 84 / 累计 126
